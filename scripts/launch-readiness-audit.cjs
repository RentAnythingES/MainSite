...
async function main() {
  ...
  const tables = ["products", "booking_drafts", "booking_inventory_blocks", "bookings", "booking_payment_events", "booking_documents", "invoice_settings", "newsletter_subscribers", "system_incidents"];
