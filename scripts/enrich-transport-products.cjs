  ...
  },
  {
    ...
    localizations: {
      en: {
        ...
        detail_description: "The G3 Reef 580 is a long, dual-opening roof box intended to add luggage capacity for road trips from Valencia. Retail specifications describe approximately 460 litres of capacity, external dimensions around 198.5 × 89 × 39.5 cm, an empty weight of about 16 kg and a maximum box load rating of 75 kg. The safe permitted load is always the lowest limit set by the box, vehicle roof and roof bars, after accounting for the box weight. This model requires a compatibility review covering the exact vehicle, roof-bar system, bar spacing, mounting hardware, lock operation and total vehicle height. An independent ADAC test in 2020 measured 440 litres of usable volume and downgraded the model after failures in the city-crash test. For that reason, Rent&Roll will not release this unit without a documented physical inspection of the shell, hinges, locks, fasteners, mounting points and internal restraint straps.",
