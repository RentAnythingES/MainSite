...
const steps = [
  ...
  },
  {
    ...
    title: "Book",
    description:
      "Select your rental dates, choose any extras, and complete your booking with our secure checkout. You'll receive instant confirmation via email.",
    details: [
      "Pick your start and end dates",
      "Add optional extras (sheets, accessories)",
  ...
  },
  {
    ...
    description:
      "We deliver directly to your hotel, Airbnb, or apartment across Valencia. Every item is professionally cleaned, sanitised, and safety-inspected.",
    details: [
      "Doorstep delivery within Valencia city & beaches",
      "Flexible time slots including evenings",
      "Self-pickup option available",
      "Every item deep-cleaned & safety-checked",
    ],
    icon: "🚚",
  ...
  },
  {
    ...
    title: "Use & Return",
    description:
      "Enjoy your rental worry-free! When your trip ends, we'll pick up the items from your location. No cleaning needed — we handle everything.",
    details: [
      "Use worry-free with our damage protection",
      "Extend your rental anytime via WhatsApp",
      "We pick up from your location",
      "No cleaning required — we deep-sanitise everything",
    ],
    icon: "✨",
