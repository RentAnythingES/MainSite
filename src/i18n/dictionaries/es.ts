...
const es: Dictionary = {
  ...
  home: {
    ...
    trustStats: [
      { number: "4.000+", label: "Alquileres entregados" },
      { number: "5★", label: "Valoraciones en Google" },
      { number: "24h", label: "Entrega disponible" },
      { number: "100%", label: "Equipos desinfectados" },
    ],
