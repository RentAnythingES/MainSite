...
export const destinationGovernance: Record<string, DestinationGovernance> = {
  ...
  "semana-santa-marinera-valencia": {
    ...
    sources: [
      {
        label: "Semana Santa Marinera 2026",
        url: "https://www.valencia.es/cas/movilidad-y-urbanismo/agenda-de-la-ciudad/-/content/semana-santa-marinera-de-valencia-2026",
        publisher: "Valencia City Council",
        supports: ["2026 dates", "collective events", "participating brotherhoods", "maritime district location"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Inclusive Semana Santa Marinera information",
        url: "https://www.valencia.es/documents/d/guest/circular-qr-inclusivo-semana-santa-marinera-2026",
        publisher: "Valencia City Council",
        supports: ["accessible information", "reduced-mobility viewing areas", "official programme links"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Semana Santa Marinera festival overview",
        url: "https://www.valencia.es/es/-/fiestas-semana-santa-marinera",
        publisher: "Valencia City Council",
        supports: ["festival history", "National Tourist Interest status", "festival museum"],
        checkedAt: "2026-07-20",
      },
    ],
  },
  "gran-fira-valencia": {
    refreshClass: "annual-event",
    contentReviewedAt: "2026-07-20",
    nextReviewAt: "2027-05-15",
    sources: [{
      label: "Feria de Julio Valencia 2026",
      url: "https://feriadejuliovlc.es/",
      publisher: "Valencia City Council",
      supports: ["2026 programme", "Gran Nit", "Batalla de Flores", "venues", "ticket and registration details"],
      checkedAt: "2026-07-20",
    }],
  },
  "corpus-christi-valencia": {
    ...
    sources: [
      {
        label: "Corpus Christi in Valencia",
        url: "https://www.visitvalencia.com/en/events-valencia/festivities/corpus-christi-in-valencia",
        publisher: "Visit Valencia",
        supports: ["festival history", "annual timing", "main rituals", "procession structure"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Corpus Christi Museum — House of the Rocks",
        url: "https://cultural.valencia.es/en/museu/corpus-christi-museum-house-of-the-rocks/",
        publisher: "Valencia City Council",
        supports: ["museum history", "Rocas collection", "visitor information"],
        checkedAt: "2026-07-20",
      },
    ],
  },
  "christmas-valencia": {
    ...
    sources: [
      {
        label: "Christmas traditions in Valencia",
        url: "https://www.visitvalencia.com/en/events-valencia/festivities/christmas-in-valencia",
        publisher: "Visit Valencia",
        supports: ["seasonal traditions", "nativity scenes", "New Year", "Three Kings", "markets"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Municipal nativity scenes",
        url: "https://www.valencia.es/cas/actualidad/-/content/bel%C3%A9n-municipal-val%C3%A8ncia",
        publisher: "Valencia City Council",
        supports: ["municipal nativity tradition", "city-centre locations", "free public access model"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Valencia nativity-scene route",
        url: "https://cultural.valencia.es/es/ruta-de-belenes-en-navidad/",
        publisher: "Valencia City Council",
        supports: ["nativity route", "municipal and cultural venues", "family planning"],
        checkedAt: "2026-07-20",
      },
    ],
  },
  ...
  "oceanografic-valencia": {
    ...
    sources: [
      {
        label: "Oceanogràfic visit planning",
        url: "https://www.oceanografic.org/en/planifica-tu-visita-al-oceanografic-de-valencia/",
        publisher: "Oceanogràfic Valencia",
        supports: ["venue layout", "daily programme", "transport", "visitor planning"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Oceanogràfic visitor FAQ",
        url: "https://www.oceanografic.org/en/faq/",
        publisher: "Oceanogràfic Valencia",
        supports: ["accessibility", "family facilities", "food rules", "lockers", "re-entry"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Oceanogràfic accessibility commitment",
        url: "https://www.oceanografic.org/nuestro-compromiso/",
        publisher: "Oceanogràfic Valencia",
        supports: ["adapted parking", "ramps", "lifts", "accessible routes"],
        checkedAt: "2026-07-20",
      },
    ],
  },
  "central-market-la-lonja": {
    ...
    sources: [
      {
        label: "Central Market visitor guide",
        url: "https://www.visitvalencia.com/en/what-to-do-valencia/valencian-culture/monuments-in-valencia/central-market",
        publisher: "Visit Valencia",
        supports: ["market history", "architecture", "visitor context"],
        checkedAt: "2026-07-20",
      },
      {
        label: "La Lonja de la Seda visitor guide",
        url: "https://www.visitvalencia.com/en/what-to-do-valencia/valencian-culture/monuments-in-valencia/lonja-silk-exchange",
        publisher: "Visit Valencia",
        supports: ["UNESCO status", "architecture", "location", "historic context"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Central Market tourism protocol",
        url: "https://www.valencia.es/documents/20142/15728607/20250203%2BPROTOCOLO-TURISMO-MERCADO-CENTRAL.pdf/074e1061-2a01-7be9-c743-8f4a05917d45?t=1738781797569",
        publisher: "Valencia City Council",
        supports: ["visitor conduct", "working-market access", "group management"],
        checkedAt: "2026-07-20",
      },
    ],
  },
  "bioparc-valencia": {
    ...
    sources: [
      {
        label: "BIOPARC visit planning",
        url: "https://bioparcvalencia.es/en/prepara-tu-visita/",
        publisher: "BIOPARC Valencia",
        supports: ["opening model", "calendar", "last admission", "visit planning"],
        checkedAt: "2026-07-20",
      },
      {
        label: "BIOPARC visitor FAQ",
        url: "https://bioparcvalencia.es/en/prepare-your-visit/information-of-interest/faqs/",
        publisher: "BIOPARC Valencia",
        supports: ["visit duration", "accessibility", "family rules", "food rules", "parking", "re-entry"],
        checkedAt: "2026-07-20",
      },
      {
        label: "How to reach BIOPARC",
        url: "https://bioparcvalencia.es/en/prepare-your-visit/information-of-interest/how-to-get/",
        publisher: "BIOPARC Valencia",
        supports: ["location", "public transport", "arrival planning"],
        checkedAt: "2026-07-20",
      },
    ],
  },
  "valencia-historic-centre": {
    ...
    sources: [
      {
        label: "Municipal historic-centre route",
        url: "https://cultural.valencia.es/en/ruta/route-through-the-historic-centre/",
        publisher: "Cultural València",
        supports: ["walking route", "route duration", "major monuments", "route endpoints"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Valencia historic city centre",
        url: "https://www.comunitatvalenciana.com/en/valencia/valencia/monuments/the-city-of-valencia-as-a-historical-unit-1",
        publisher: "Turisme Comunitat Valenciana",
        supports: ["historic development", "heritage status", "major landmarks", "visitor context"],
        checkedAt: "2026-07-20",
      },
    ],
  },
  ...
  "el-saler-beach": {
    ...
    sources: [
      {
        label: "El Saler municipal beach guide",
        url: "https://www.valencia.es/es/-/playa-el-saler",
        publisher: "Valencia City Council",
        supports: ["beach length", "facilities", "accessibility", "seasonal services"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Valencia assisted bathing programme",
        url: "https://www.valencia.es/es/-/ba%C3%B1o-adaptado",
        publisher: "Valencia City Council",
        supports: ["assisted bathing", "advance booking", "accessible beach support"],
        checkedAt: "2026-07-20",
      },
    ],
  },
  "pinedo-beach": {
    ...
    sources: [
      {
        label: "Pinedo beach service charter",
        url: "https://www.valencia.es/documents/20142/180607/CARTA%2520DE%2520SERVICIOS%2520PLAYA%2520DE%2520PINEDO.pdf/c9b96d10-a2f1-497c-ea1b-cee6ec714d2a",
        publisher: "Valencia City Council",
        supports: ["beach characteristics", "facilities", "accessible point", "public transport"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Accessible beaches in Valencia",
        url: "https://www.visitvalencia.com/en/valencia-accesible/playas-accesibles",
        publisher: "Visit Valencia",
        supports: ["accessible point location", "adapted facilities", "bathing assistance"],
        checkedAt: "2026-07-20",
      },
    ],
  },
  ...
  "bunol-day-trip": {
    ...
    sources: [
      {
        label: "Buñol Castle",
        url: "https://turismo.bunyol.es/castillo-de-bunol/",
        publisher: "Ayuntamiento de Buñol",
        supports: ["castle history", "free admission", "old-town highlights"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Natural and active tourism in Buñol",
        url: "https://turismo.bunyol.es/turismo-natural-y-deportivo/",
        publisher: "Ayuntamiento de Buñol",
        supports: ["natural setting", "walking routes", "river landscapes"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Buñol destination overview",
        url: "https://www.spain.info/en/destination/bunol/",
        publisher: "Turespaña",
        supports: ["distance from Valencia", "heritage context", "destination orientation"],
        checkedAt: "2026-07-20",
      },
    ],
  },
  "cullera-day-trip": {
    ...
    sources: [
      {
        label: "Cullera Castle visitor guide",
        url: "https://visit-cullera.es/guia/castillo-de-cullera/",
        publisher: "Tourist Info Cullera",
        supports: ["castle history", "visitor services", "accessibility", "opening model"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Cullera beaches",
        url: "https://visit-cullera.es/actividades/playas-cullera/",
        publisher: "Tourist Info Cullera",
        supports: ["beach types", "accessible beaches", "coastal services"],
        checkedAt: "2026-07-20",
      },
      {
        label: "Getting to and around Cullera",
        url: "https://visit-cullera.es/como-llegar-transportes/",
        publisher: "Tourist Info Cullera",
        supports: ["rail connection", "local bus connection", "accessible local transport"],
        checkedAt: "2026-07-20",
      },
    ],
  },
...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    type: "event",
    tagline: "Valencia's maritime Holy Week, shaped by neighbourhood processions and seafaring traditions",
    heroImage: "/discover/semana-santa-marinera.jpg",
    heroImageAlt: "Semana Santa Marinera procession in Valencia's maritime neighbourhoods",
    heroImageProvenance: {
      status: "licensed",
      creator: "Jorge Sanz",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Semana_Santa_Marinera_(16997625666).jpg",
      license: "CC BY-SA 2.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/2.0/",
      verifiedAt: "2026-07-20",
      modifications: "Resized to 1280 pixels wide by Wikimedia Commons.",
    },
    title: "Semana Santa Marinera Valencia Guide 2026",
    description: "Plan Semana Santa Marinera in Valencia with 2026 dates, key processions, maritime neighbourhood routes, accessibility and family advice.",
    keywords: ["Semana Santa Marinera Valencia", "Holy Week Valencia", "Valencia Easter processions", "Cabanyal Semana Santa"],
    date: "2026-07-20",
    lastUpdated: "2026-07-20",
    audiences: ["families", "mobility-needs", "couples", "elderly"],
    region: "Poblats Marítims, Valencia",
    hubs: ["events"],
    eventInfo: {
      dates: "27 March–5 April 2026",
      frequency: "Annual — dates follow Holy Week",
      ticketsRequired: false,
      ticketUrl: "https://www.valencia.es/cas/movilidad-y-urbanismo/agenda-de-la-ciudad/-/content/semana-santa-marinera-de-valencia-2026",
      crowdLevel: "high",
      bookingAdvice: "The street processions are free. Choose the event and neighbourhood section you want to see, then check the official programme and transport restrictions shortly before travelling.",
      whatToExpect: [
        "Processions organised by 31 brotherhoods, confraternities and corporations across Valencia's maritime districts",
        "Three major collective events: the Holy Thursday Visits to the Monuments, the Good Friday Holy Burial Procession and the Easter Sunday Resurrection Parade",
        "Biblical characters, religious images, music and traditions closely connected to Cabanyal, Canyamelar and Grau",
        "Long routes, temporary street closures and dense crowds around the principal processions",
      ],
      safetyTips: [
        "Keep procession routes clear and follow steward or police instructions at crossings.",
        "Set a meeting point away from the route if visiting with children or a group.",
        "Carry water and a light layer; some events continue into the evening.",
        "Use the official inclusive information and designated viewing guidance if reduced mobility affects your plan.",
      ],
      months: [3, 4],
    },
    overview: {
      paragraphs: [
        "Semana Santa Marinera is Valencia's distinctive maritime Holy Week. Rather than centring on one square, its processions move through the Poblats Marítims, where religious brotherhoods and neighbourhood communities maintain traditions connected to the sea. The festival was declared of National Tourist Interest in 2011.",
        "The most useful way to plan is to choose one of the three collective events and then confirm its current route. Holy Thursday focuses on visits to the Holy Monuments, Good Friday brings the solemn Holy Burial Procession, and Easter Sunday changes the atmosphere with the Resurrection Parade.",
        "This remains a living religious observance, not a staged attraction. Visitors are welcome, but should leave space for participants, avoid blocking doorways and treat private homes displaying religious images with respect.",
      ],
      quickFacts: [
        { label: "2026 dates", value: "27 March–5 April" },
        { label: "Main area", value: "Cabanyal, Canyamelar and Grau" },
        { label: "Cost", value: "Street processions are free" },
        { label: "Planning", value: "Use the current official programme" },
      ],
    },
    highlights: [
      { name: "Good Friday Holy Burial", description: "The principal solemn collective procession brings the maritime brotherhoods together along a published route.", icon: "🕯️", tip: "Choose a viewing point before the procession begins rather than trying to follow the full route." },
      { name: "Resurrection Parade", description: "Easter Sunday has a brighter, celebratory character and is often the most approachable collective event for families.", icon: "🌿", tip: "Confirm the current start time and route because Holy Week dates change annually." },
      { name: "Maritime neighbourhood traditions", description: "Processions pass through working residential streets, with images hosted in homes and local communities participating directly.", icon: "⚓" },
      { name: "Festival museum", description: "The Museo de la Semana Santa Marinera Salvador Caurín provides year-round context at Calle Rosario 1.", icon: "🏛️", tip: "Check the museum's current opening information separately from the festival programme." },
    ],
    gettingThere: {
      summary: "The processions take place across the maritime districts, so the best stop depends on the current route rather than a single festival entrance.",
      options: [
        { mode: "tram", description: "Metrovalencia tram services connect the city with Cabanyal and the seafront. Check event-day service changes.", tip: "Select a stop near your chosen route section, not simply the beach." },
        { mode: "bus", description: "EMT routes serve the maritime neighbourhoods but diversions are likely around processions.", tip: "Use live journey planning on the day." },
        { mode: "bike", description: "Cycling is practical before road closures intensify, but do not take bicycles into dense viewing areas." },
        { mode: "walk", description: "Walking between Cabanyal, Canyamelar and Grau is possible, although barriers can lengthen routes." },
      ],
      parkingNotes: "Avoid relying on street parking inside the procession area. Closures, restricted access and crowds make public transport the more predictable choice.",
    },
    bestTimeToVisit: {
      summary: "Choose the event that matches your group rather than treating every procession as interchangeable.",
      seasons: [
        { season: "spring", description: "The festival takes place around Easter. Daytime conditions are often mild, but evening temperatures and rain vary.", rating: 5 },
        { season: "summer", description: "The festival does not take place in summer; visit the museum for year-round context.", rating: 1 },
        { season: "autumn", description: "The festival does not take place in autumn; visit the museum for year-round context.", rating: 1 },
        { season: "winter", description: "Preparations may be visible locally, but the public festival follows Holy Week in spring.", rating: 1 },
      ],
    },
    whatToBring: {
      bring: ["Comfortable walking shoes", "Water", "A light evening layer", "Current route saved offline", "Respectful clothing and behaviour"],
      dontBring: ["Large luggage", "Bicycles into packed viewing areas", "Equipment that blocks pavements"],
      rentInstead: ["A compact stroller for younger children", "A suitable mobility aid for longer walking routes"],
    },
    accessibility: {
      overallRating: 3,
      summary: "The festival publishes inclusive information and designated reduced-mobility viewing guidance for principal events, but historic streets, crowds and route changes still require preparation.",
      wheelchairNotes: "Review the official inclusive QR information and current designated viewing areas. Confirm the exact location and access route before travelling.",
      strollerNotes: "A compact stroller is easier than a large travel system. Avoid the densest sections and keep clear of procession routes.",
      publicTransportAccess: "Accessible tram and bus services reach the area, although event diversions and crowding can affect the final approach.",
    },
    practicalTips: [
      "Download the current official programme; routes and timings are annual, not evergreen.",
      "Pick one collective event and one viewing area instead of attempting to follow every procession.",
      "Arrive before road closures make the final approach slower.",
      "Keep voices low during solemn processions and ask before photographing people at close range.",
    ],
    visitingHere: {
      summary: "A successful visit combines one procession with time in the maritime neighbourhoods, without trying to cross every route or attend every event.",
      idealDuration: "2–4 hours for one procession section",
      bestTimeOfDay: "Depends on the official event; daytime is generally easier with young children",
      tips: [
        "Choose your viewing section before leaving your accommodation.",
        "Keep a quieter fallback plan near the seafront if crowds become uncomfortable.",
        "Allow extra time to reach restaurants or transport after the procession passes.",
      ],
    },
    productWidgets: [
      { categorySlug: "baby-gear", heading: "Planning Holy Week with children?", afterSection: "Accessibility" },
      { categorySlug: "mobility", heading: "Need support for longer routes?", afterSection: "Getting There" },
    ],
    relatedDestinations: ["cabanyal", "malvarrosa-beach"],
    relatedBlogPosts: ["valencia-with-kids-complete-guide", "wheelchair-accessible-valencia"],
    faqs: [
      { question: "When is Semana Santa Marinera in 2026?", answer: "The official 2026 programme runs from 27 March to 5 April. Individual procession times and routes should be checked on the Valencia City Council event page." },
      { question: "Do I need tickets for Semana Santa Marinera?", answer: "No ticket is required to watch the public street processions. Some separate venues or activities may have their own access conditions." },
      { question: "Which procession should families choose?", answer: "The Easter Sunday Resurrection Parade has a more celebratory atmosphere. Whatever you choose, use a less congested route section, bring water and agree a meeting point." },
      { question: "Is Semana Santa Marinera accessible?", answer: "Valencia publishes inclusive information and designated reduced-mobility viewing guidance for major events. Check the current locations and access instructions before travelling." },
    ],
  },
  {
    ...
    type: "event",
    tagline: "A month of outdoor culture, neighbourhood events, fireworks and summer traditions across Valencia",
    heroImage: "/discover/gran-fira-valencia.jpg",
    heroImageAlt: "Flower-covered floats during Valencia's July Fair Battle of Flowers",
    heroImageProvenance: {
      status: "licensed",
      creator: "Rafa Esteve",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Gran_Fira_Valencia_2016_Batalla_de_Flors_03.jpg",
      license: "CC BY-SA 4.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/4.0/",
      verifiedAt: "2026-07-20",
      modifications: "Resized to 1280 pixels wide by Wikimedia Commons.",
    },
    title: "Feria de Julio Valencia 2026: Gran Fira Guide",
    description: "Plan Valencia's Feria de Julio 2026 with Gran Nit, Battle of Flowers, family events, ticket guidance, heat planning and official programme links.",
    keywords: ["Feria de Julio Valencia", "Gran Fira Valencia", "Valencia July events", "Batalla de Flores Valencia"],
    date: "2026-07-20",
    lastUpdated: "2026-07-20",
    audiences: ["families", "couples", "budget", "elderly"],
    region: "Valencia citywide",
    hubs: ["events"],
    eventInfo: {
      dates: "1–26 July 2026",
      frequency: "Annual July programme",
      ticketsRequired: false,
      ticketUrl: "https://feriadejuliovlc.es/",
      crowdLevel: "high",
      bookingAdvice: "Many activities are free, while selected concerts and registered activities require tickets or advance booking. Build your plan from the official current-year programme.",
      whatToExpect: [
        "Around 300 music, culture, fireworks, tradition and entertainment activities across Valencia in 2026",
        "Gran Nit on 18 July, with a concentrated evening programme and later activity across the city",
        "The Battle of Flowers finale on Passeig de l'Albereda on 26 July 2026",
        "Neighbourhood events, family activities, concerts and fireworks with different access rules",
      ],
      safetyTips: [
        "Plan water, shade and indoor breaks before attending daytime activities in July heat.",
        "Use hearing protection for children and noise-sensitive visitors at fireworks.",
        "Set a meeting point for Gran Nit and the Battle of Flowers, where crowds can be dense.",
        "Check late-night public transport and road closures before the event begins.",
      ],
      months: [7],
    },
    overview: {
      paragraphs: [
        "Valencia's Feria de Julio, also widely known as the Gran Fira, spreads summer culture across the city rather than operating as one fenced festival. The 2026 programme brings together around 300 activities including music, neighbourhood events, family entertainment, fireworks and long-running Valencian traditions.",
        "Two dates anchor many visitor plans: Gran Nit on 18 July and the Battle of Flowers on 26 July. They are very different experiences. Gran Nit is an evening of simultaneous activity, while the Battle of Flowers is a specific parade-style finale at Passeig de l'Albereda.",
        "The programme changes every year. Use this guide to choose the right event type and manage heat, transport and crowds, then use the official site for final times, locations, cancellations, registration and ticket rules.",
      ],
      quickFacts: [
        { label: "2026 programme", value: "1–26 July" },
        { label: "Scale", value: "Around 300 activities" },
        { label: "Gran Nit", value: "18 July 2026" },
        { label: "Battle of Flowers", value: "26 July, Passeig de l'Albereda" },
      ],
    },
    highlights: [
      { name: "Gran Nit", description: "A citywide summer night with cultural activities and entertainment concentrated into one evening.", icon: "🌙", tip: "Choose two nearby activities rather than crossing the city repeatedly." },
      { name: "Battle of Flowers", description: "Flower-covered floats and a playful flower battle close the July programme along Passeig de l'Albereda.", icon: "🌸", tip: "Confirm current access, seating and ticket arrangements on the official programme." },
      { name: "Viveros concerts", description: "The Jardines de Viveros concert programme is a major strand, with separate tickets and venue rules.", icon: "🎵", tip: "Treat concert admission separately from the mostly free city programme." },
      { name: "Neighbourhood programme", description: "Events extend beyond the centre, including family, music and community activities in neighbourhoods and outlying districts.", icon: "📍" },
    ],
    gettingThere: {
      summary: "There is no single festival entrance. Match transport to the venue listed in the official programme and check event-day changes.",
      options: [
        { mode: "metro", description: "Metrovalencia is useful for distributed venues and late journeys, subject to current operating hours." },
        { mode: "bus", description: "EMT serves central and neighbourhood venues, with possible diversions around major events." },
        { mode: "bike", description: "Valencia's cycle network works well for many outdoor locations before crowds build." },
        { mode: "walk", description: "Walking suits grouped central events during Gran Nit, but July heat makes daytime distances more demanding." },
      ],
      parkingNotes: "Do not assume normal road access around the Battle of Flowers, Gran Nit or fireworks. Public transport is usually more predictable.",
    },
    bestTimeToVisit: {
      summary: "Evening events reduce heat exposure, while family activities may run earlier. Choose by programme, temperature and your group's stamina.",
      seasons: [
        { season: "spring", description: "The July Fair does not take place in spring.", rating: 1 },
        { season: "summer", description: "July is the festival season. Expect heat, strong sun and warm nights; schedule breaks and hydration.", rating: 5 },
        { season: "autumn", description: "The July Fair does not take place in autumn.", rating: 1 },
        { season: "winter", description: "The July Fair does not take place in winter.", rating: 1 },
      ],
      avoidDates: "Avoid overloading a single day with daytime heat and late-night events. Build recovery time into the following morning.",
    },
    whatToBring: {
      bring: ["Refillable water bottle", "Sun protection", "Light clothing", "Official programme saved on your phone", "Hearing protection for fireworks"],
      dontBring: ["Large bags at ticketed venues", "Glass containers", "Equipment that is difficult to carry through crowds"],
      rentInstead: ["A compact stroller for family events", "Beach or outdoor equipment for daytime plans between events"],
    },
    accessibility: {
      overallRating: 3,
      summary: "Accessibility varies because the programme uses many venues. Confirm the route, surface, seating and assistance directly for each selected activity.",
      wheelchairNotes: "Check the individual venue and official event listing. A citywide festival cannot guarantee one consistent access arrangement.",
      strollerNotes: "Compact strollers work best in crowds. Evening timing and heat may be more important than distance for younger children.",
      publicTransportAccess: "Many central venues are well served, but closures and late finishes can change the most practical route home.",
    },
    practicalTips: [
      "Filter the official programme by date and area before choosing activities.",
      "Distinguish free public events from concerts or activities requiring tickets or registration.",
      "Plan a long indoor or shaded break during the hottest part of the afternoon.",
      "Check weather, firework notices, transport and cancellation status again on the day.",
    ],
    visitingHere: {
      summary: "The strongest plan combines one headline event with nearby smaller activities, instead of treating the Feria de Julio as a single place to visit.",
      idealDuration: "2–5 hours per selected programme block",
      bestTimeOfDay: "Late afternoon and evening, with heat precautions",
      tips: [
        "Group activities by neighbourhood or transport corridor.",
        "Keep the following morning lighter after Gran Nit or a late concert.",
        "Have a quieter alternative if fireworks, heat or crowds become uncomfortable.",
      ],
    },
    productWidgets: [
      { categorySlug: "travel-outdoors", heading: "Planning a Valencia summer day?", afterSection: "What to Bring" },
      { categorySlug: "baby-gear", heading: "Attending with young children?", afterSection: "Accessibility" },
    ],
    relatedDestinations: ["turia-gardens", "malvarrosa-beach", "albufera"],
    relatedBlogPosts: ["valencia-summer-survival-guide", "valencia-with-kids-complete-guide"],
    faqs: [
      { question: "When is Valencia's Feria de Julio in 2026?", answer: "The official 2026 programme runs across July, with listed activities from 1 to 26 July. Gran Nit is on 18 July and the Battle of Flowers finale is on 26 July." },
      { question: "Is the Feria de Julio free?", answer: "Many city and neighbourhood activities are free, but selected concerts and registered activities require tickets or advance booking. Check each listing on the official programme." },
      { question: "Where does the Gran Fira take place?", answer: "Across Valencia. Venues include central spaces, neighbourhoods, Jardines de Viveros and Passeig de l'Albereda, so every event needs its own route plan." },
      { question: "Is the Feria de Julio suitable for children?", answer: "Yes, the programme includes family activities. Choose age-appropriate events, avoid prolonged midday heat and bring hearing protection for fireworks or loud performances." },
    ],
  },
  {
    slug: "albufera",
  ...
  // ===== OCEANOGRÀFIC =====
  {
    ...
    type: "attraction",
    tagline: "A practical guide to Europe's largest aquarium, from family pacing to accessible routes",
    heroImage: "/discover/oceanografic-valencia.jpg",
    heroImageAlt: "White curved buildings and water at Oceanogràfic Valencia",
    heroImageProvenance: {
      status: "licensed",
      creator: "Andrew Stobart",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Oceanogr%C3%A0fic_Valencia.jpg",
      license: "CC BY-SA 4.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/4.0/",
      verifiedAt: "2026-07-20",
      modifications: "Resized to 1280 pixels wide by Wikimedia Commons.",
    },
    title: "Oceanogràfic Valencia: Practical Visitor Guide",
    description: "Plan your Oceanogràfic Valencia visit with family pacing, accessibility, food rules, transport and practical advice for a comfortable aquarium day.",
    keywords: ["Oceanogràfic Valencia", "Valencia aquarium", "Oceanogràfic with kids", "Oceanogràfic accessibility"],
    date: "2026-07-20",
    lastUpdated: "2026-07-20",
    audiences: ["families", "mobility-needs", "couples", "elderly"],
    region: "City of Arts and Sciences, Valencia",
    distanceFromValencia: "Around 20-30 minutes from the historic centre",
    hubs: ["attractions"],
    overview: {
      paragraphs: [
        "Oceanogràfic is the aquarium within Valencia's City of Arts and Sciences and is presented by the venue as the largest aquarium in Europe. Its route moves through marine habitats including the Mediterranean, oceans, tropical islands, the Arctic and Antarctic, with large indoor exhibits connected by exposed outdoor paths.",
        "This is not a quick single-building museum. Families should plan the visit around walking distance, meals, rest breaks and the current activity programme. A focused visit can fill half a day, while groups who stop at most habitats and activities may use most of a day.",
        "Opening times, admission prices and activity schedules vary by date. Check the official calendar immediately before booking and again on arrival rather than relying on an old guide or screenshot.",
      ],
      quickFacts: [
        { label: "Best for", value: "Marine life, families and an all-weather attraction day" },
        { label: "Time to allow", value: "At least half a day; longer with children and activities" },
        { label: "Food rule", value: "Outside food is not permitted" },
        { label: "Access", value: "Ramps, lifts and adapted routes across the complex" },
      ],
    },
    highlights: [
      {
        name: "Marine habitat route",
        description: "The visit connects distinct marine environments rather than presenting one conventional aquarium hall. Use the official map to decide which zones are priorities for your group.",
        icon: "🐠",
      },
      {
        name: "Underwater tunnel",
        description: "The ocean habitat includes a walk-through tunnel where sharks and other marine animals pass overhead, one of the venue's most recognisable experiences.",
        icon: "🦈",
      },
      {
        name: "Daily activities",
        description: "Talks, feeds and presentations can shape the route, but schedules can change for operational, weather or animal-welfare reasons.",
        icon: "🗓️",
        tip: "Check the day's programme on arrival and choose only the activities worth reorganising the route around.",
      },
    ],
    gettingThere: {
      summary: "Oceanogràfic is at the eastern end of the City of Arts and Sciences. Public transport, bicycle, taxi and car are all possible.",
      options: [
        { mode: "bus", description: "Use the current EMT journey planner for the stop closest to Oceanogràfic rather than the wider complex.", duration: "Usually 20-35 minutes from central Valencia" },
        { mode: "bike", description: "The Turia Gardens provides a largely flat approach, but secure the bicycle outside and plan for summer heat.", duration: "Approximately 15-25 minutes from the centre" },
        { mode: "car", description: "The venue has a large car park with adapted spaces. Check the current parking terms on the official site." },
        { mode: "walk", description: "Walking through the Turia Gardens is attractive and flat, but adds substantial distance before a long venue visit.", duration: "Approximately 35-50 minutes from the old town" },
      ],
      parkingNotes: "The official accessibility information lists adapted spaces both in the car park and on the street. Availability is not guaranteed.",
    },
    bestTimeToVisit: {
      summary: "Arrive near opening time for a calmer start. The route mixes indoor areas with exposed outdoor walking, so weather and heat matter.",
      seasons: [
        { season: "spring", description: "Comfortable for moving between habitats, with school and holiday peaks still worth checking.", rating: 5 },
        { season: "summer", description: "Indoor exhibits provide relief, but outdoor links can be hot and busy. Start early and build in water breaks.", rating: 3 },
        { season: "autumn", description: "Often comfortable for a full route, with visitor levels depending on school and holiday dates.", rating: 5 },
        { season: "winter", description: "A useful mixed indoor-outdoor option. Check weather and the date-specific schedule before travelling.", rating: 4 },
      ],
    },
    accessibility: {
      overallRating: 5,
      summary: "The official venue information describes ramps, lifts, automatic doors, non-slip surfaces and an adapted route across its buildings.",
      wheelchairNotes: "Manual wheelchairs can be borrowed subject to availability with a refundable deposit. Confirm current conditions with the venue before relying on a loan.",
      strollerNotes: "The route accommodates strollers, but it covers a large site. Bring only what you can manage through long walking sections and meal stops.",
      publicTransportAccess: "Check the current accessible EMT route and the final approach from the stop. Adapted parking spaces are also listed by the venue.",
    },
    visitingHere: {
      summary: "Treat Oceanogràfic as the main activity of the day. Choose priority habitats, note the current activity schedule and decide where the group will eat before starting the route.",
      idealDuration: "4-7 hours depending on pace and activities",
      bestTimeOfDay: "Near opening time for a quieter start",
      tips: [
        "Photograph the day's activity board or save the official schedule before entering the main route.",
        "Use the breastfeeding and baby-changing rooms behind the information point when travelling with an infant.",
        "Agree a meeting point if adults and older children separate because the site is large.",
      ],
    },
    practicalTips: [
      "Wear comfortable shoes; walking distances inside the complex are substantial.",
      "Do not bring a picnic expecting to eat it inside because outside food is not permitted.",
      "Lockers are available, but payment conditions and availability can change.",
      "Re-entry is restricted, so confirm the rule before leaving the venue during your visit.",
    ],
    productWidgets: [
      { categorySlug: "baby-gear", heading: "Make a family attraction day easier", afterSection: "Highlights" },
      { categorySlug: "mobility", heading: "Need mobility support during your stay?", afterSection: "Accessibility" },
    ],
    relatedDestinations: ["city-of-arts-and-sciences", "turia-gardens"],
    relatedBlogPosts: ["valencia-with-kids-complete-guide", "wheelchair-accessibility-valencia"],
    faqs: [
      { question: "How long should I allow for Oceanogràfic Valencia?", answer: "Allow at least half a day. Families, visitors who attend several scheduled activities and anyone moving at a relaxed pace may need most of a day." },
      { question: "Can I bring food into Oceanogràfic?", answer: "The official FAQ states that outside food is not permitted. Plan to use the venue's food options and confirm dietary requirements directly before visiting." },
      { question: "Is Oceanogràfic accessible for wheelchair users?", answer: "The venue lists ramps, lifts, automatic doors, adapted routes and wheelchair loans subject to availability. Confirm any essential arrangements before travelling." },
      { question: "Should I buy Oceanogràfic tickets in advance?", answer: "Advance booking is sensible for busy dates, but prices, opening hours and ticket combinations change. Use the official Oceanogràfic calendar for your exact date." },
    ],
  },
  ...
  // ===== CENTRAL MARKET & LA LONJA =====
  {
    ...
    name: "Central Market & La Lonja",
    type: "attraction",
    tagline: "A practical morning route through Valencia's landmark food market and UNESCO silk exchange",
    heroImage: "/discover/central-market-la-lonja.jpg",
    heroImageAlt: "Gothic stone façade of La Lonja de la Seda in Valencia",
    heroImageProvenance: {
      status: "licensed",
      creator: "Pamdelinaza",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Lonja_de_la_Seda,_Valencia,_Espa%C3%B1a.jpg",
      license: "CC0 1.0",
      licenseUrl: "https://creativecommons.org/publicdomain/zero/1.0/",
      verifiedAt: "2026-07-20",
      modifications: "Resized to 1280 pixels wide by Wikimedia Commons.",
    },
    title: "Central Market & La Lonja Valencia Guide",
    description: "Plan a Valencia Central Market and La Lonja visit with route order, historic context, accessibility and respectful market-day advice.",
    keywords: ["Central Market Valencia", "La Lonja Valencia", "Mercado Central Valencia", "Valencia historic centre"],
    date: "2026-07-20",
    lastUpdated: "2026-07-20",
    audiences: ["families", "couples", "elderly", "mobility-needs", "budget"],
    region: "Historic Centre, Valencia",
    distanceFromValencia: "In the centre, beside Plaça del Mercat",
    hubs: ["attractions"],
    overview: {
      paragraphs: [
        "Valencia's Central Market and La Lonja de la Seda stand opposite each other in the historic centre, making them one of the city's easiest high-value sightseeing combinations. The market is a working food hall inside a landmark modernist building; La Lonja is a UNESCO-listed masterpiece of late Gothic civil architecture.",
        "Visit the market first while trade is active, then cross Plaça del Mercat for La Lonja. The route is compact, but both places deserve attention: the market for local food culture and architectural details, La Lonja for its spiral columns, trading history and quieter interior spaces.",
        "Market access and monument opening arrangements can change. Confirm current official hours shortly before visiting, especially on Sundays, public holidays and dates affected by local events.",
      ],
      quickFacts: [
        { label: "Best order", value: "Central Market first, then La Lonja" },
        { label: "Time to allow", value: "Around 2-3 hours at a relaxed pace" },
        { label: "Architecture", value: "Modernist market and Gothic civil monument" },
        { label: "Location", value: "Opposite sides of Plaça del Mercat" },
      ],
    },
    highlights: [
      {
        name: "Central Market",
        description: "A major modernist market hall filled with produce, fish, meat, preserved foods and specialist stalls. It remains a place of work rather than a staged visitor attraction.",
        icon: "🍊",
        tip: "Keep aisles and counters clear, ask before photographing stallholders closely and make purchases without blocking regular customers.",
      },
      {
        name: "La Lonja's Column Hall",
        description: "The main trading hall is defined by tall spiral columns and a vaulted ceiling, expressing the commercial importance of Valencia during the city's historic silk trade.",
        icon: "🏛️",
      },
      {
        name: "Plaça del Mercat",
        description: "The square links the market, La Lonja and the Church of Santos Juanes, creating a compact architectural ensemble in the old town.",
        icon: "📍",
      },
    ],
    gettingThere: {
      summary: "The sites are in the pedestrian-heavy historic centre. Walking and public transport are usually simpler than driving.",
      options: [
        { mode: "walk", description: "The route is easy to combine with El Carmen, Plaça de la Reina and other central sights.", duration: "Around 5-15 minutes from most old-town landmarks" },
        { mode: "bus", description: "Several EMT routes serve the centre. Check the current journey planner because diversions affect historic streets." },
        { mode: "metro", description: "Àngel Guimerà, Xàtiva and Colón can all be practical depending on your starting point, followed by a walk." },
        { mode: "bike", description: "Use designated parking outside the busiest pedestrian area and continue on foot." },
      ],
      parkingNotes: "Central traffic restrictions and limited parking make a car inconvenient. Use a public car park only after checking access rules and height limits.",
    },
    bestTimeToVisit: {
      summary: "Plan this as a morning route so the market is active. Earlier visits are usually easier for movement and photography.",
      seasons: [
        { season: "spring", description: "Comfortable weather for combining the interiors with a wider old-town walk.", rating: 5 },
        { season: "summer", description: "Start early, use the interiors as shade and avoid turning the route into a long midday walk.", rating: 4 },
        { season: "autumn", description: "A strong season for market produce and comfortable historic-centre walking.", rating: 5 },
        { season: "winter", description: "Both interiors work well on cooler days, subject to holiday closures.", rating: 4 },
      ],
    },
    accessibility: {
      overallRating: 4,
      summary: "The route is short and largely level, but busy aisles, historic paving and monument entrances require more attention than a modern attraction.",
      wheelchairNotes: "Confirm the current step-free entrance for each building before travelling. Inside the market, visit early for clearer aisles and easier turning space.",
      strollerNotes: "A compact stroller is easier in the market. Keep it close to the edge when stopping and avoid peak crowding around popular counters.",
      publicTransportAccess: "Central bus and metro options reduce the need to cross the restricted centre by car, but the final approach is on foot over mixed urban surfaces.",
    },
    visitingHere: {
      summary: "Use the market as the time-sensitive first stop, then cross to La Lonja and continue into El Carmen or towards Valencia Cathedral if energy and weather allow.",
      idealDuration: "2-3 hours",
      bestTimeOfDay: "Morning, while Central Market is trading",
      tips: [
        "Check both buildings' official opening information because their schedules are independent.",
        "Keep purchases manageable if you plan to continue walking through the old town.",
        "Treat the market as a workplace: move aside before stopping, photographing or organising a group.",
      ],
    },
    practicalTips: [
      "Bring a reusable bag for market purchases and consider how perishable food will be stored.",
      "Avoid promising a fixed arrival time based on old online listings; local schedules can change.",
      "Small groups move more comfortably through the market than a single tightly packed group.",
      "Pair the route with El Carmen rather than crossing the city to another major attraction on the same morning.",
    ],
    productWidgets: [
      { categorySlug: "baby-gear", heading: "Exploring the historic centre with children?", afterSection: "Highlights" },
      { categorySlug: "mobility", heading: "Need mobility support for the city stay?", afterSection: "Accessibility" },
    ],
    relatedDestinations: ["el-carmen", "el-ensanche"],
    relatedBlogPosts: ["valencia-with-kids-complete-guide", "wheelchair-accessibility-valencia"],
    faqs: [
      { question: "Should I visit Central Market or La Lonja first?", answer: "Visit Central Market first because it operates as a working morning market, then cross the square to La Lonja. Confirm both current schedules before setting out." },
      { question: "How much time do I need for both?", answer: "Allow around two to three hours for an unhurried visit, including time to browse the market, see La Lonja and move through Plaça del Mercat." },
      { question: "Is Central Market suitable for children?", answer: "Yes, but it is busy and operational. Keep children close, use a compact stroller where possible and avoid blocking aisles or counters." },
      { question: "Is La Lonja de la Seda a UNESCO site?", answer: "Yes. La Lonja de la Seda is listed as a UNESCO World Heritage Site and is one of Europe's important examples of civil Gothic architecture." },
    ],
  },
  ...
  // ===== BIOPARC =====
  {
    ...
    type: "attraction",
    tagline: "An immersive African wildlife park at the western end of the Turia Gardens",
    heroImage: "/discover/bioparc-valencia.jpg",
    heroImageAlt: "Landscaped African habitat with rocks, water and vegetation at BIOPARC Valencia",
    heroImageProvenance: {
      status: "licensed",
      creator: "Gabriel Villena",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Bioparc_Valencia_II_(2787453634).jpg",
      license: "CC BY 2.0",
      licenseUrl: "https://creativecommons.org/licenses/by/2.0/",
      verifiedAt: "2026-07-20",
      modifications: "Resized to 1280 pixels wide by Wikimedia Commons.",
    },
    title: "BIOPARC Valencia Guide: Tickets, Access & Families",
    description: "Plan a BIOPARC Valencia visit with official ticket guidance, realistic timing, transport, accessibility, food rules and family logistics.",
    keywords: ["BIOPARC Valencia", "Bioparc Valencia tickets", "Valencia zoo", "Bioparc Valencia with kids"],
    date: "2026-07-20",
    lastUpdated: "2026-07-20",
    audiences: ["families", "mobility-needs", "elderly", "couples"],
    region: "Western Valencia",
    hubs: ["attractions"],
    overview: {
      paragraphs: [
        "BIOPARC Valencia is an immersive wildlife park beside Parque de Cabecera at the western end of the Turia Gardens. Its zoo-immersion design uses landscaping, water, rockwork and planned sightlines to connect African habitats rather than presenting the visit as a row of separate cages.",
        "Treat BIOPARC as a main activity, not a quick stop. The official FAQ describes an experience that can fill an entire day, supported by a changing activity schedule, restaurants and a children's play area. Animals choose where to rest within their habitats, so sightings vary throughout the day.",
        "Opening and closing times depend on the selected date and available daylight. Check the official calendar before buying tickets, choose the correct entry slot and avoid relying on old price or timetable listings.",
      ],
      quickFacts: [
        { label: "Visit length", value: "Half day to a full day" },
        { label: "Opening model", value: "Open daily; closing time varies" },
        { label: "Accessibility", value: "Officially described as fully accessible" },
        { label: "Re-entry", value: "Normally not permitted" },
      ],
    },
    highlights: [
      { name: "African habitats", description: "Landscaped, mixed-species environments create broad views and reward returning to the same area later in the day.", icon: "🦒", tip: "Use the current park map and activity agenda rather than rushing through once." },
      { name: "Daily activities", description: "The official agenda adds educational activities across the day and can change by date.", icon: "📅", tip: "Check the agenda after selecting your visit date." },
      { name: "Family facilities", description: "Restaurants, children's options and a play area support a longer visit without leaving the park.", icon: "👨‍👩‍👧" },
    ],
    gettingThere: {
      summary: "BIOPARC sits by Parque de Cabecera, west of the historic centre. Plan the final approach separately from a central Valencia walking day.",
      options: [
        { mode: "metro", description: "Metrovalencia provides a practical approach from central districts; confirm the current station and walking route on the official directions page." },
        { mode: "bus", description: "EMT services reach the surrounding area. Use live journey planning for the selected date." },
        { mode: "bike", description: "The Turia Gardens offers a mostly traffic-separated approach from central Valencia.", tip: "Bicycles cannot be used inside the park." },
        { mode: "car", description: "BIOPARC has private underground parking with current conditions published in its FAQ." },
      ],
      parkingNotes: "The official FAQ lists underground parking for vehicles up to 2.20 metres, with tariffs and hours subject to change. Verify both directly.",
    },
    bestTimeToVisit: {
      summary: "Choose an opening-time arrival when possible, especially in hot weather or on busy family dates.",
      seasons: [
        { season: "spring", description: "Comfortable temperatures make a long outdoor visit easier. Check Easter demand and ticket conditions.", rating: 5 },
        { season: "summer", description: "Start early, plan water and shade, and avoid forcing a full route during the hottest hours.", rating: 3 },
        { season: "autumn", description: "Often comfortable for walking, with daylight-dependent closing times becoming earlier.", rating: 5 },
        { season: "winter", description: "A workable quieter-season visit, but daylight and weather affect visibility and closing time.", rating: 4 },
      ],
    },
    whatToBring: {
      bring: ["Date-specific tickets", "Water in a non-glass container", "Sun protection", "Comfortable shoes", "Current park map"],
      dontBring: ["Outside food beyond permitted baby food or young-child snacks", "Glass containers", "Bicycles or scooters for use inside", "Flash photography equipment"],
      rentInstead: ["A compact stroller for younger children", "A suitable mobility aid for a long walking day"],
    },
    accessibility: {
      overallRating: 5,
      summary: "BIOPARC's official FAQ describes the park as fully accessible. Visitors with specific assistance, documentation or companion requirements should confirm details before arrival.",
      wheelchairNotes: "The public route is described as accessible. Confirm any temporary closure, equipment need or discount documentation directly with BIOPARC.",
      strollerNotes: "The park suits strollers, but the visit can last many hours. A compact model makes restaurant, crowd and transport transitions easier.",
      publicTransportAccess: "Public transport reaches the surrounding area; check official directions and live operator information for the final step.",
    },
    practicalTips: [
      "Select the date on the official calendar before relying on opening or closing times.",
      "Do not plan to leave for lunch and re-enter; normal re-entry is not permitted.",
      "Current rules allow water in non-glass containers, baby food and some snacks for younger children, but not general outside food.",
      "Animal visibility changes naturally; revisit favourite habitats instead of expecting every animal on demand.",
    ],
    visitingHere: {
      summary: "BIOPARC works best as the main activity for the day, with a flexible route built around the official agenda, weather and your group's walking pace.",
      idealDuration: "4–7 hours",
      bestTimeOfDay: "Near opening time for cooler conditions and a full activity window",
      tips: ["Save the current map before starting.", "Choose meal and rest points before children become tired.", "Pair the visit only with nearby Parque de Cabecera, not another major attraction across the city."],
    },
    productWidgets: [
      { categorySlug: "baby-gear", heading: "Planning a full family day?", afterSection: "Accessibility" },
      { categorySlug: "mobility", heading: "Need support for a long walking route?", afterSection: "Getting There" },
    ],
    relatedDestinations: ["turia-gardens", "valencia-historic-centre"],
    relatedBlogPosts: ["valencia-with-kids-complete-guide", "wheelchair-accessibility-valencia"],
    faqs: [
      { question: "How long do I need at BIOPARC Valencia?", answer: "Allow at least half a day. BIOPARC states that its habitats, daily activities, restaurants and family facilities can support a complete day visit." },
      { question: "Is BIOPARC Valencia accessible?", answer: "The official FAQ describes the park as fully accessible. Confirm any essential assistance, documentation or temporary route issue directly before travelling." },
      { question: "Can I bring food into BIOPARC?", answer: "Current rules do not allow general outside food or drink except water in non-glass containers, baby food and some snacks for younger children." },
      { question: "Can I leave and re-enter BIOPARC?", answer: "Normally no. The official FAQ says re-entry is not permitted unless a new ticket is purchased or staff authorise an exceptional case." },
    ],
  },
  ...
  // ===== VALENCIA HISTORIC CENTRE =====
  {
    ...
    name: "Valencia Historic Centre",
    type: "attraction",
    tagline: "A practical walking route through 2,000 years of Valencia's civic, religious and trading history",
    heroImage: "/discover/valencia-historic-centre.jpg",
    heroImageAlt: "Plaza de la Virgen, Valencia Cathedral and Basilica in Valencia's historic centre",
    heroImageProvenance: {
      status: "licensed",
      creator: "Jl FilpoC",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Plaza_de_la_Virgen,_Valencia.jpg",
      license: "CC BY-SA 4.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/4.0/",
      verifiedAt: "2026-07-20",
      modifications: "Resized to 1280 pixels wide by Wikimedia Commons.",
    },
    title: "Valencia Historic Centre: Self-Guided Walking Route",
    description: "Walk Valencia's historic centre from Serranos to Quart with a realistic route, key monuments, accessibility, family pacing and local tips.",
    keywords: ["Valencia historic centre", "Valencia old town walking route", "what to see Valencia old town", "Ciutat Vella Valencia"],
    date: "2026-07-20",
    lastUpdated: "2026-07-20",
    audiences: ["families", "mobility-needs", "elderly", "couples", "budget"],
    region: "Ciutat Vella, Valencia",
    hubs: ["attractions"],
    overview: {
      paragraphs: [
        "Valencia's historic centre brings Roman foundations, Islamic walls, medieval gates, Gothic trading wealth and later civic architecture into a compact walkable area. Turisme Comunitat Valenciana identifies more than 20 officially recognised cultural heritage sites within the historic centre.",
        "The municipal cultural route provides a useful one-hour spine from Torres de Serranos to Torres de Quart. That timing covers the walk, not meaningful visits inside the Cathedral, Almoina, La Lonja, Central Market or other monuments. Allow half a day for a selective route and a full day only if your group handles long urban walks comfortably.",
        "This guide owns broad old-town orientation. Use the separate Central Market and La Lonja guide for that focused morning pairing, and the El Carmen guide when deciding whether to stay in or explore the neighbourhood itself.",
      ],
      quickFacts: [
        { label: "Core route", value: "Serranos Towers to Quart Towers" },
        { label: "Walking spine", value: "About 1 hour without interior visits" },
        { label: "Realistic visit", value: "Half day with selected monuments" },
        { label: "Best approach", value: "Choose 2–3 interiors, not every landmark" },
      ],
    },
    highlights: [
      { name: "Serranos and Quart Towers", description: "The two surviving fortified gates create natural endpoints for a route across Ciutat Vella.", icon: "🏰", tip: "Start at Serranos and finish through El Carmen at Quart for a clear westward route." },
      { name: "Plaza de la Virgen and Cathedral", description: "The civic and religious heart of the route connects the Basilica, Cathedral, Micalet and archaeological history around Almoina.", icon: "⛪", tip: "Treat Cathedral and tower entry as a separate time decision." },
      { name: "Market Square", description: "Central Market and UNESCO-listed La Lonja reveal Valencia's food culture and medieval trading power.", icon: "🏛️", tip: "Use the dedicated Market and La Lonja guide for opening-order details." },
      { name: "Plaza del Ayuntamiento", description: "A broad civic square provides a useful contrast to the narrow medieval street network.", icon: "📍" },
    ],
    gettingThere: {
      summary: "Enter the historic centre by public transport and walk between clusters. Driving between individual monuments is slower and less practical.",
      options: [
        { mode: "metro", description: "Several central Metrovalencia stations provide access to different ends of Ciutat Vella. Choose by your route direction." },
        { mode: "bus", description: "EMT serves the perimeter and central squares, with changes during events and road closures." },
        { mode: "bike", description: "Cycle to the edge of the route, then walk in the busiest pedestrian streets." },
        { mode: "walk", description: "The core route is walkable, but monument entries, detours and historic surfaces increase time and effort." },
      ],
      parkingNotes: "Central underground car parks exist, but restricted streets and pedestrian areas make public transport or walking the simpler default.",
    },
    bestTimeToVisit: {
      summary: "Start in the morning for working-market atmosphere and cooler walking, then prioritise monuments by their current opening hours.",
      seasons: [
        { season: "spring", description: "Comfortable walking weather, with festival routes and closures requiring date-specific checks.", rating: 5 },
        { season: "summer", description: "Start early, use shaded streets and indoor monuments, and avoid a continuous midday walking route.", rating: 3 },
        { season: "autumn", description: "Strong walking conditions outside heavy-rain periods, with fewer heat constraints.", rating: 5 },
        { season: "winter", description: "Mild daytime walking is possible; shorter daylight makes a focused route more useful.", rating: 4 },
      ],
    },
    whatToBring: {
      bring: ["Comfortable shoes", "Water", "Sun protection", "Offline route map", "A short list of priority interiors"],
      dontBring: ["Large luggage", "An overfilled monument checklist", "A car-dependent point-to-point plan"],
      rentInstead: ["A compact stroller for younger children", "A mobility aid suited to several hours on mixed urban surfaces"],
    },
    accessibility: {
      overallRating: 3,
      summary: "Many squares and pedestrian routes are accessible, but historic paving, monument thresholds, crowds and individual interior routes vary.",
      wheelchairNotes: "Confirm the step-free entrance and lift status for every paid interior that matters. Build the route around accessible entrances rather than visual proximity alone.",
      strollerNotes: "A compact stroller handles crowds and café stops better. Some towers and historic interiors require carrying or leaving it outside." ,
      publicTransportAccess: "Accessible public transport reaches the perimeter and main squares, but the final route uses varied pedestrian surfaces.",
    },
    practicalTips: [
      "Use the municipal Serranos-to-Quart route as a spine, not a promise that every monument fits into one hour.",
      "Select two or three interiors and enjoy the remaining landmarks from the public route.",
      "Check each monument's official hours independently; nearby buildings do not share one schedule.",
      "Plan a seated break around Plaza de la Virgen, Plaza de la Reina or Market Square before fatigue sets in.",
    ],
    visitingHere: {
      summary: "A strong first visit follows one continuous route and chooses a few interiors, rather than repeatedly crossing Ciutat Vella to tick off landmarks.",
      idealDuration: "3–5 hours for a selective route",
      bestTimeOfDay: "Morning into early afternoon",
      tips: ["Start near Serranos if you want a clear westward route.", "Visit Central Market before it loses its morning activity.", "Keep El Carmen as the final flexible section near Quart Towers."],
    },
    productWidgets: [
      { categorySlug: "baby-gear", heading: "Exploring Ciutat Vella with children?", afterSection: "Accessibility" },
      { categorySlug: "mobility", heading: "Need support for an old-town walking day?", afterSection: "Getting There" },
    ],
    relatedDestinations: ["central-market-la-lonja", "el-carmen", "el-ensanche"],
    relatedBlogPosts: ["valencia-with-kids-complete-guide", "wheelchair-accessibility-valencia"],
    faqs: [
      { question: "How long do I need for Valencia's historic centre?", answer: "The municipal walking spine takes about one hour without interior visits. Allow three to five hours for a useful first visit with two or three monuments." },
      { question: "What should I see first in Valencia old town?", answer: "A practical route starts at Serranos Towers, continues through Plaza de la Virgen and the Cathedral area, reaches Market Square, and finishes through El Carmen at Quart Towers." },
      { question: "Is Valencia's historic centre accessible?", answer: "Large parts are pedestrian and relatively level, but historic surfaces and monument entrances vary. Confirm step-free access for every interior you consider essential." },
      { question: "Is the historic centre the same as El Carmen?", answer: "No. El Carmen is one neighbourhood within Ciutat Vella. The broader historic-centre route also includes the Cathedral area, Market Square, civic centre and other old-town districts." },
    ],
  },
  ...
  },
  {
    ...
    name: "Pinedo Beach",
    type: "beach",
    tagline: "A local beach south of the port with strong accessible facilities and a rural edge",
    heroImage: "/discover/pinedo-beach.jpg",
    heroImageAlt: "Wide sandy Pinedo Beach south of Valencia with the Mediterranean Sea",
    heroImageProvenance: {
      status: "licensed",
      creator: "Boris Dzhingarov",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Playa_de_Pinedo,_Valencia,_Spain_(29813566664).jpg",
      license: "CC BY 2.0",
      licenseUrl: "https://creativecommons.org/licenses/by/2.0/",
      verifiedAt: "2026-07-20",
      modifications: "Resized to 1280 pixels wide by Wikimedia Commons.",
    },
    title: "Pinedo Beach Valencia: Accessible Local Guide",
    description: "Plan a visit to Pinedo Beach near Valencia, with accessible facilities, transport, family advice, seasonal services and practical beach-day planning.",
    keywords: ["Pinedo beach Valencia", "accessible beach Valencia", "quiet beach Valencia", "Pinedo beach guide"],
    date: "2026-07-20",
    lastUpdated: "2026-07-20",
    audiences: ["families", "mobility-needs", "elderly", "couples"],
    region: "Poblats del Sud / South Valencia",
    distanceFromValencia: "Around 20-30 minutes from central Valencia",
    hubs: ["beaches"],
    overview: {
      paragraphs: [
        "Pinedo is the first beach south of Valencia's port and the northern gateway to the more natural beaches around Albufera. Its municipal service charter describes approximately 1.5 kilometres of fine golden sand, moderate occupancy and a setting that feels less urban than Malvarrosa.",
        "The beach stands out for its accessible point near health post 1. Published facilities include adapted walkways, toilets, changing and shower areas, reserved parking, Braille information and seasonal assisted bathing with amphibious equipment.",
        "Pinedo is useful for visitors who want a local beach with facilities but less city-centre intensity. It still requires advance planning: confirm the current transport route, seasonal service dates and the exact access point before travelling.",
      ],
      quickFacts: [
        { label: "Beach length", value: "Approximately 1.5 km" },
        { label: "Setting", value: "Local beach between the port and Albufera coastline" },
        { label: "Best for", value: "Accessible visits, families and a quieter atmosphere" },
        { label: "Accessible point", value: "Near health post 1" },
      ],
    },
    highlights: [
      {
        name: "Established accessible point",
        description: "The accessible area includes adapted routes and facilities, reserved space and seasonal bathing assistance. Confirm current operating dates before your visit.",
        icon: "♿",
      },
      {
        name: "Moderate, local atmosphere",
        description: "Pinedo generally feels less urban than Valencia's northern beaches while retaining public facilities and places to eat nearby.",
        icon: "🏖️",
      },
      {
        name: "South-coast starting point",
        description: "The beach sits before the longer natural coastline towards L'Arbre del Gos and El Saler, making it a practical comparison point for southern beach plans.",
        icon: "🧭",
      },
    ],
    gettingThere: {
      summary: "Pinedo can be reached by public bus, taxi, bicycle or car. Check the final distance to your chosen beach access before setting out.",
      options: [
        { mode: "bus", description: "EMT serves Pinedo. Consult the current route planner for the nearest stop to health post 1 or your chosen access.", duration: "Usually 20-35 minutes from central Valencia" },
        { mode: "bike", description: "A southbound cycling route is possible from Valencia, but summer heat and the return distance should be considered.", duration: "Approximately 35-50 minutes from the centre" },
        { mode: "car", description: "Public and adapted parking are listed in the municipal beach services. Availability is not guaranteed during busy periods." },
      ],
      parkingNotes: "For accessible visits, confirm the designated parking and route to health post 1 rather than relying on a general map pin.",
    },
    bestTimeToVisit: {
      summary: "Summer provides the widest range of services. June and September are often more comfortable than peak August for a long visit.",
      seasons: [
        { season: "spring", description: "Suitable for walks and quiet time outdoors; swimming and seasonal services may be limited.", rating: 3 },
        { season: "summer", description: "Warm water and the main service season. Arrive early and confirm assisted-bathing hours if required.", rating: 5 },
        { season: "autumn", description: "September can remain warm with fewer visitors. Later autumn is better for walking than swimming.", rating: 4 },
        { season: "winter", description: "Quiet and exposed, with limited facilities. Choose settled weather for a seafront walk.", rating: 2 },
      ],
    },
    whatToBring: {
      bring: ["Sun protection", "Water", "Beach towel", "Any personal accessibility equipment or medication"],
      dontBring: ["Glass containers", "Unnecessary valuables", "Equipment you cannot manage between the stop or car and the sand"],
      rentInstead: ["Beach shade", "Supportive chairs", "Cooler", "Beach transport equipment"],
    },
    accessibility: {
      overallRating: 5,
      summary: "Pinedo is one of Valencia's designated accessible beaches. The published accessible point is at health post 1 and includes adapted routes, facilities and seasonal bathing support.",
      wheelchairNotes: "The service charter lists adapted walkways, toilets, changing space, showers, parking and amphibious bathing equipment. Confirm dates, capacity and whether advance booking is needed.",
      strollerNotes: "Use the principal marked accesses. The beach is easier to plan than a completely natural shoreline, but loose sand still limits ordinary stroller wheels.",
      publicTransportAccess: "The city lists public and adapted transport to the beach. Verify the current route and distance to the accessible point.",
    },
    visitingHere: {
      summary: "Pinedo can work for a short local visit or a complete beach day. Visitors using the accessible point should plan around health post 1 and confirm the service directly before departure.",
      idealDuration: "3-6 hours",
      bestTimeOfDay: "Morning for lower heat and simpler setup",
      tips: [
        "Use health post 1 as the reference point for an accessible visit.",
        "Confirm lifeguard and bathing-assistance schedules because they are seasonal.",
        "If visiting with a dog, verify whether the separate seasonal dog-beach area is operating and review its current rules.",
      ],
    },
    practicalTips: [
      "Check the sea-condition flag and follow lifeguard instructions before swimming.",
      "Reserve accessible bathing assistance in advance whenever the current service requires it.",
      "Do not assume every access has the same facilities; choose your arrival point deliberately.",
      "Keep the distinction between the general beach and any separately marked dog-friendly area clear.",
    ],
    productWidgets: [
      { categorySlug: "travel-outdoors", heading: "Make the beach day easier", afterSection: "Highlights" },
      { categorySlug: "mobility", heading: "Need additional mobility support?", afterSection: "Accessibility" },
    ],
    relatedDestinations: ["el-saler-beach", "malvarrosa-beach", "albufera"],
    relatedBlogPosts: ["wheelchair-accessibility-valencia", "best-beaches-valencia-families"],
    faqs: [
      { question: "Is Pinedo Beach accessible?", answer: "Yes. Pinedo is one of Valencia's designated accessible beaches. Its accessible point near health post 1 includes adapted facilities and seasonal assisted bathing. Confirm dates and booking requirements before travelling." },
      { question: "How do I reach Pinedo Beach from Valencia?", answer: "Public bus, taxi, bicycle and car are possible. Use the current EMT route planner and choose the exact beach access in advance, particularly if you need the accessible point." },
      { question: "Can I take a dog to Pinedo Beach?", answer: "Valencia has operated a separately marked seasonal dog-beach area at Pinedo. Its opening dates, hours and rules can change, so confirm the current municipal information before bringing a dog." },
    ],
  },
  {
    slug: "el-saler-beach",
    name: "El Saler Beach",
    type: "beach",
    tagline: "Dunes, pine forest and a more natural beach day south of Valencia",
    heroImage: "/discover/el-saler-beach.jpg",
    heroImageAlt: "Sand, dunes and Mediterranean water at El Saler Beach near Valencia",
    heroImageProvenance: {
      status: "licensed",
      creator: "Ron Oliver",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:El_Saler_beach.jpg",
      license: "CC BY-SA 4.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/4.0/",
      verifiedAt: "2026-07-20",
      modifications: "Resized to 1280 pixels wide by Wikimedia Commons.",
    },
    title: "El Saler Beach Valencia: Local Visitor Guide",
    description: "Plan a day at El Saler Beach near Valencia, with transport, facilities, accessibility, dune protection and practical family beach advice.",
    keywords: ["El Saler beach", "El Saler beach Valencia", "natural beach Valencia", "beaches near Valencia"],
    date: "2026-07-20",
    lastUpdated: "2026-07-20",
    audiences: ["families", "couples", "mobility-needs"],
    region: "Albufera Natural Park / South Valencia",
    distanceFromValencia: "Around 25-35 minutes from central Valencia",
    hubs: ["beaches"],
    overview: {
      paragraphs: [
        "El Saler offers a more natural beach experience than Valencia's urban seafront. It sits south of the city within the Albufera Natural Park landscape, where a long stretch of fine golden sand is backed by protected dunes and pine forest.",
        "The beach is approximately 2.6 kilometres long and has summer facilities, lifeguard posts, toilets, showers, picnic tables, shade areas and adapted access. Services are spread across several access points rather than concentrated on one continuous promenade, so choosing the right arrival point matters when carrying equipment.",
        "This is a good choice for visitors who value space and natural surroundings, but it requires more planning than Malvarrosa or Patacona. Check transport, beach-service dates and the current sea conditions before leaving Valencia.",
      ],
      quickFacts: [
        { label: "Beach length", value: "Approximately 2.6 km" },
        { label: "Setting", value: "Dunes and pine forest within Albufera Natural Park" },
        { label: "Best for", value: "Nature, space and longer beach days" },
        { label: "Services", value: "Seasonal lifeguards, toilets, showers and accessible facilities" },
      ],
    },
    highlights: [
      {
        name: "Protected dune landscape",
        description: "The dune and pine setting makes El Saler feel distinctly different from the city beaches. Use the marked paths and wooden walkways to protect the vegetation.",
        icon: "🌿",
      },
      {
        name: "Long, open beach",
        description: "The broad shoreline gives visitors more room to spread out, especially away from the busiest access points.",
        icon: "🏖️",
      },
      {
        name: "Seasonal accessible point",
        description: "The municipal beach guide lists adapted parking, access, toilets, showers and a summer accessible point near health post 2.",
        icon: "♿",
        tip: "Assisted bathing at El Saler requires advance confirmation. Contact the municipal service before travelling.",
      },
    ],
    gettingThere: {
      summary: "Public bus, taxi, bicycle and car are possible, but the final walking distance varies substantially by access point.",
      options: [
        { mode: "bus", description: "EMT serves the El Saler area. Check the current route and closest beach access for your date before travelling.", duration: "Usually 25-40 minutes from central Valencia" },
        { mode: "bike", description: "A southbound cycling route is possible for confident riders, but allow for heat, distance and the return journey.", duration: "Approximately 45-60 minutes from the city centre" },
        { mode: "car", description: "Delimited, unguarded parking is available near beach access points and includes adapted spaces. It fills during summer weekends." },
      ],
      parkingNotes: "Do not park on dunes, verges or protected vegetation. Use designated parking and carry valuables with you.",
    },
    bestTimeToVisit: {
      summary: "June and September balance warm conditions with fewer peak-August crowds. Arrive early during summer weekends.",
      seasons: [
        { season: "spring", description: "Comfortable for walking and picnics, although the sea remains cool and seasonal services may be limited.", rating: 4 },
        { season: "summer", description: "Best for swimming and full seasonal services. Heat, parking pressure and UV exposure require planning.", rating: 5 },
        { season: "autumn", description: "September can still offer warm water and a quieter beach. Later autumn suits walks more than swimming.", rating: 4 },
        { season: "winter", description: "A peaceful natural setting for walking on suitable weather days, with limited beach services.", rating: 2 },
      ],
      avoidDates: "Peak summer weekends after late morning, when parking and the main access points can be busiest.",
    },
    whatToBring: {
      bring: ["Sun protection", "Plenty of water", "Food or a confirmed meal plan", "A bag for all rubbish"],
      dontBring: ["Glass containers", "Anything that requires crossing protected dunes", "More equipment than your group can safely carry"],
      rentInstead: ["Beach umbrella or shelter", "Cooler", "Beach chairs", "Beach wagon where the chosen access is suitable"],
    },
    accessibility: {
      overallRating: 4,
      summary: "The city lists adapted parking, access, toilets and showers, plus a seasonal accessible point near health post 2. Exact services and assisted-bathing availability must be confirmed for the visit date.",
      wheelchairNotes: "Use the designated accessible entrance and confirm the current walkway arrangement. Natural sand remains difficult beyond adapted surfaces.",
      strollerNotes: "Choose a marked walkway and avoid dragging a stroller over protected dunes. A beach wagon may be easier for equipment but still depends on the access surface.",
      publicTransportAccess: "The municipal guide lists an adapted EMT bus, but verify the current route and final distance before travelling.",
    },
    visitingHere: {
      summary: "El Saler works best as a planned half-day or full-day outing rather than a quick city-beach stop. Select an access point before leaving and bring enough water, shade and food for your group.",
      idealDuration: "4-7 hours",
      bestTimeOfDay: "Morning for easier parking, lower heat and calmer setup",
      tips: [
        "Save the exact access or parking point before leaving because the beach is long.",
        "Use only marked paths through the dunes and take every item of rubbish away.",
        "Check the beach flag, lifeguard coverage and assisted-bathing arrangements on the day.",
      ],
    },
    practicalTips: [
      "Plan shade carefully; the pine forest does not provide shade on the sand itself.",
      "Keep food chilled during summer and bring more drinking water than you expect to use.",
      "Mobile coverage and nearby commercial services should not replace a complete beach-day plan.",
      "The beach sits in a protected natural landscape, so follow signs and never cross fenced dune areas.",
    ],
    productWidgets: [
      { categorySlug: "travel-outdoors", heading: "Prepare for a full beach day", afterSection: "Highlights" },
    ],
    relatedDestinations: ["pinedo-beach", "albufera", "malvarrosa-beach"],
    relatedBlogPosts: ["best-beaches-valencia-families", "valencia-summer-survival-guide"],
    faqs: [
      { question: "How do I get to El Saler Beach from Valencia?", answer: "You can use EMT bus services, taxi, bicycle or car. Check the current route and choose a specific beach access before travelling because El Saler is long and facilities are distributed across several points." },
      { question: "Is El Saler Beach suitable for families?", answer: "Yes, especially for families seeking space and natural surroundings. It needs more preparation than an urban beach, so bring shade, water and food and arrive early on summer weekends." },
      { question: "Is El Saler Beach accessible?", answer: "The city lists adapted parking, access, toilets, showers and a seasonal accessible point near health post 2. Assisted bathing requires advance confirmation with the municipal service." },
    ],
  },
  {
    slug: "bunol-day-trip",
    name: "Buñol",
    type: "day-trip",
    tagline: "A castle town and river landscape beyond the famous tomato festival",
    heroImage: "/discover/bunol-day-trip.jpg",
    heroImageAlt: "Historic centre and tiled church dome seen from Buñol Castle",
    heroImageProvenance: {
      status: "licensed",
      creator: "Enrique Íñiguez Rodríguez",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Bu%C3%B1ol._Castillo._Vistas.jpg",
      license: "CC BY-SA 3.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/3.0/",
      verifiedAt: "2026-07-20",
      modifications: "Resized to 1280 pixels wide by Wikimedia Commons.",
    },
    title: "Buñol Day Trip from Valencia: Castle & Old Town",
    description: "Plan a Buñol day trip from Valencia with castle, old-town and nature stops, realistic walking advice, transport checks and Tomatina-day warnings.",
    keywords: ["Buñol day trip", "Buñol from Valencia", "Buñol Castle", "things to do in Buñol"],
    date: "2026-07-20",
    lastUpdated: "2026-07-20",
    audiences: ["families", "couples", "elderly", "mobility-needs"],
    region: "Hoya de Buñol, Valencia",
    distanceFromValencia: "About 39 km west of Valencia",
    hubs: ["day-trips"],
    overview: {
      paragraphs: [
        "Buñol is best known internationally for La Tomatina, but the town works as a very different day trip during the rest of the year. Its medieval castle sits within the historic centre rather than above it as a separate monument, while nearby streets, fountains and the river landscape create a compact inland outing.",
        "Start with the castle and old town, then add one nature stop only if the weather, daylight and your return transport allow it. The municipal tourism office highlights San Luis Park, Molino Galán, historic fountains and routes through the surrounding landscape, but these should not all be forced into one short visit.",
        "Normal-day planning does not apply during La Tomatina or other major local events. Access controls, crowds and transport can change substantially, so use the current municipal event information and operator timetable for your exact date.",
      ],
      quickFacts: [
        { label: "Best for", value: "Castle, old-town and inland scenery" },
        { label: "Core visit", value: "Half day; longer with a nature route" },
        { label: "Castle admission", value: "Municipal tourism lists free entry" },
        { label: "Important exception", value: "La Tomatina requires separate planning" },
      ],
    },
    highlights: [
      { name: "Buñol Castle", description: "An 11th- to 12th-century fortress integrated into the old town, with two enclosures and views across Buñol.", icon: "🏰", tip: "Check the municipal tourism page for any temporary access notice before travelling." },
      { name: "Historic centre", description: "The streets around the castle connect San Pedro church, traditional houses and a network of historic fountains.", icon: "🏘️", tip: "Wear shoes suitable for slopes, steps and uneven surfaces." },
      { name: "San Luis and the river landscape", description: "San Luis Park and the municipality's natural routes offer a greener second half to the day away from the castle streets.", icon: "🌿", tip: "Choose a route that fits the season and remaining daylight rather than improvising a long walk." },
    ],
    gettingThere: {
      summary: "Buñol is connected with Valencia by regional public transport, but services and disruptions must be checked for the travel date.",
      options: [
        { mode: "train", description: "Check Renfe Cercanías Valencia for the current C-3 service, replacement transport and the final return option before leaving." },
        { mode: "bus", description: "Regional coach services can be an alternative when timings work. Confirm the current operator, stop and return timetable." },
        { mode: "car", description: "Driving gives more flexibility for a nature stop, but central streets and event-day controls can complicate parking." },
      ],
      parkingNotes: "Use signed public parking and avoid entering narrow old-town streets without checking access. Event-day arrangements can be completely different.",
    },
    bestTimeToVisit: {
      summary: "Spring and autumn are easiest for combining the castle with outdoor walking. In summer, start early and shorten exposed routes.",
      seasons: [
        { season: "spring", description: "Comfortable for the castle, town and a selected nature route, subject to rain conditions.", rating: 5 },
        { season: "summer", description: "The old town is visitable, but heat makes exposed walking harder. La Tomatina dates require event-specific planning.", rating: 3 },
        { season: "autumn", description: "A strong season for inland scenery and cooler walking conditions.", rating: 5 },
        { season: "winter", description: "Suitable for a shorter heritage visit when weather and daylight are favourable.", rating: 3 },
      ],
      avoidDates: "Do not treat La Tomatina day as an ordinary sightseeing trip. Entry, transport and crowd conditions are exceptional.",
    },
    whatToBring: {
      bring: ["Current return timetable", "Water", "Sun or rain protection", "Shoes for slopes and uneven ground"],
      dontBring: ["A rigid sightseeing schedule", "More equipment than you can carry through the old town", "Tomatina assumptions on a normal visit"],
      rentInstead: ["A compact stroller only if your route avoids the steepest steps", "A suitable mobility aid after checking castle access"],
    },
    accessibility: {
      overallRating: 2,
      summary: "Buñol's historic slopes, steps and castle surfaces can be difficult. Build an accessible route around specific confirmed entrances rather than assuming the full circuit is step-free.",
      wheelchairNotes: "Contact municipal tourism before travel to confirm the practical castle entrance, surfaces and any temporary restriction important to your visit.",
      strollerNotes: "A compact stroller can help in town, but steps and uneven castle surfaces may require carrying it.",
      publicTransportAccess: "Confirm station accessibility and any replacement transport directly with the operator for the chosen date.",
    },
    visitingHere: {
      summary: "A sensible first visit combines the castle, a slow old-town walk and one green stop. Add a longer natural route only with suitable weather and a secure return plan.",
      idealDuration: "5-7 hours including travel",
      bestTimeOfDay: "Morning arrival for cooler walking and a less rushed return",
      tips: [
        "Start at the castle while energy and temperatures are favourable.",
        "Choose lunch or a nature route as the flexible part of the itinerary.",
        "Save the final return service and an alternative before leaving Valencia.",
      ],
    },
    practicalTips: [
      "Check both municipal tourism notices and the transport operator shortly before travel.",
      "Expect slopes and irregular surfaces around the castle and old town.",
      "Keep La Tomatina planning separate from an ordinary Buñol day trip.",
      "In hot weather, prioritise the castle and shaded town stops over a long exposed route.",
    ],
    productWidgets: [],
    relatedDestinations: ["requena", "xativa", "sagunto"],
    relatedBlogPosts: ["valencia-with-kids-complete-guide", "valencia-summer-survival-guide"],
    faqs: [
      { question: "Is Buñol worth visiting outside La Tomatina?", answer: "Yes. The castle, old town, fountains and surrounding natural landscape form a distinct inland day trip. The experience is much calmer and should be planned separately from the festival." },
      { question: "Can I visit Buñol from Valencia by train?", answer: "Buñol is served by the Valencia Cercanías network, but service patterns and replacement transport can change. Check the current C-3 information and final return option directly with Renfe." },
      { question: "Is Buñol Castle free?", answer: "The municipal tourism site currently states that the castle can be visited free of charge. Check the official page for temporary closures or access changes before travelling." },
      { question: "Is Buñol accessible with a wheelchair or stroller?", answer: "The historic centre and castle include slopes, steps and uneven surfaces. Confirm the practical accessible route with municipal tourism and plan a shorter alternative if needed." },
    ],
  },
  {
    ...
    name: "Cullera",
    type: "day-trip",
    tagline: "A castle, old town and broad Mediterranean beaches in one practical coastal trip",
    heroImage: "/discover/cullera-day-trip.jpg",
    heroImageAlt: "Palm-lined San Antonio Beach with Cullera's coastal mountain in the background",
    heroImageProvenance: {
      status: "licensed",
      creator: "velomartinez",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Cullera_-_panoramio.jpg",
      license: "CC BY-SA 3.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/3.0/",
      verifiedAt: "2026-07-20",
      modifications: "Resized to 1280 pixels wide by Wikimedia Commons.",
    },
    title: "Cullera Day Trip from Valencia: Castle & Beaches",
    description: "Plan a Cullera day trip from Valencia with castle access, beach choices, station transfers, accessibility guidance and a realistic one-day route.",
    keywords: ["Cullera day trip", "Cullera from Valencia", "Cullera Castle", "Cullera beaches"],
    date: "2026-07-20",
    lastUpdated: "2026-07-20",
    audiences: ["families", "couples", "elderly", "mobility-needs"],
    region: "Ribera Baixa, Valencia",
    distanceFromValencia: "About 45 km south of Valencia",
    hubs: ["day-trips"],
    overview: {
      paragraphs: [
        "Cullera combines a historic hill town with a long Mediterranean coastline. The castle and sanctuary look across the old centre, rice fields, Júcar river and bay, while eleven named beaches range from urban, serviced stretches to quieter and more natural sections.",
        "For a first day trip, choose two anchors: the castle and one beach area. San Antonio is the simplest urban option for services and the local tourist office, while other beaches suit visitors seeking calmer surroundings, water sports or more natural landscapes.",
        "The rail station is inland rather than on the seafront. Cullera's official transport page lists a local bus connecting the station, town centre, beaches and lighthouse area, so check that timetable before assuming the final transfer is walkable or immediate.",
      ],
      quickFacts: [
        { label: "Best for", value: "Castle views plus a beach afternoon" },
        { label: "Core visit", value: "Full day" },
        { label: "Coastline", value: "More than 15 km across 11 beaches" },
        { label: "Station transfer", value: "Plan local bus, taxi or a long walk" },
      ],
    },
    highlights: [
      { name: "Cullera Castle", description: "A fortification of Islamic origin with a municipal history and archaeology museum, sanctuary and views over the bay and rice-growing landscape.", icon: "🏰", tip: "Opening hours and admission vary by season; verify the official castle page for your date." },
      { name: "San Antonio Beach", description: "The main urban beach offers a promenade, nearby services and the easiest first-time orientation.", icon: "🏖️", tip: "It is one of the beaches listed with an accessible point; confirm seasonal assistance before travel." },
      { name: "Old town and Calvary path", description: "The historic route climbs from the Barrio del Pou toward the castle, linking traditional streets with the former walled perimeter.", icon: "🚶", tip: "The climb is steep. Use the road approach or panoramic lift when appropriate and operating." },
    ],
    gettingThere: {
      summary: "Cullera has a direct rail connection from Valencia, followed by a separate transfer to the centre, castle or beach.",
      options: [
        { mode: "train", description: "Use Renfe Cercanías toward Gandia and confirm the current timetable, station accessibility and final return service." },
        { mode: "bus", description: "The official local bus connects the Renfe station with the town centre, beaches and lighthouse area. Check current hours and seasonal changes." },
        { mode: "car", description: "Driving simplifies moving between castle and beach, but parking pressure rises near the coast in summer." },
      ],
      parkingNotes: "Choose parking based on the first stop rather than expecting one space to serve the castle, old town and beach. Follow signed restrictions near the coast.",
    },
    bestTimeToVisit: {
      summary: "Late spring and early autumn balance castle walking with beach time. Summer works best with an early castle visit and a heat-aware afternoon.",
      seasons: [
        { season: "spring", description: "Comfortable for the castle and old town; beach time depends on water and weather conditions.", rating: 5 },
        { season: "summer", description: "Best for swimming and seasonal services, but heat and parking require an early start.", rating: 4 },
        { season: "autumn", description: "September can combine warm sea conditions with easier sightseeing; later autumn suits heritage and walking.", rating: 5 },
        { season: "winter", description: "A quieter castle-and-promenade outing, with limited beach services and shorter daylight.", rating: 3 },
      ],
    },
    whatToBring: {
      bring: ["Current train and local-bus timetables", "Water", "Sun protection", "Shoes for the castle climb", "Beach flag awareness"],
      dontBring: ["Too much beach equipment for a multi-stage public-transport journey", "A plan that depends on an unverified seasonal lift or tourist train"],
      rentInstead: ["Beach shade", "Chairs or towels when delivery arrangements fit your stay", "A suitable mobility aid after checking the castle route"],
    },
    accessibility: {
      overallRating: 3,
      summary: "Cullera offers accessible local buses, several accessible beach points and adapted castle parking with a panoramic lift, but services are seasonal and weather-dependent.",
      wheelchairNotes: "The official castle page lists adapted parking and a panoramic lift that does not operate in rain or wind. Confirm its current hours and the accessible route before travel.",
      strollerNotes: "The promenade is straightforward, while the Calvary path and castle approach are steep. Use an appropriate road or lift approach instead of forcing the historic climb.",
      publicTransportAccess: "The local bus is described as accessible and connects the station with central and coastal areas. Verify the current timetable and stop for your destination.",
    },
    visitingHere: {
      summary: "Visit the castle first, have lunch in town or near the coast, then choose one beach for the afternoon. This avoids repeated transfers and protects the heritage visit from midday heat.",
      idealDuration: "8-10 hours including travel",
      bestTimeOfDay: "Castle in the morning; beach or promenade later",
      tips: [
        "Check the castle's date-specific opening before choosing the train.",
        "Select the beach before leaving Valencia; Cullera's coastline is too extensive to treat as one stop.",
        "Keep the station-to-beach transfer and final return train in the itinerary.",
      ],
    },
    practicalTips: [
      "Do not assume the rail station is beside the beach; plan the local transfer.",
      "Use official beach information to match services, accessibility and atmosphere to your group.",
      "Check the swimming flag and seasonal lifeguard coverage on arrival.",
      "Confirm castle lift operation if it is essential to the visit.",
    ],
    productWidgets: [
      { categorySlug: "travel-outdoors", heading: "Prepare for a Cullera beach day", afterSection: "Highlights" },
    ],
    relatedDestinations: ["albufera", "el-saler-beach", "xativa"],
    relatedBlogPosts: ["best-beaches-valencia-families", "valencia-with-kids-complete-guide"],
    faqs: [
      { question: "Can I visit Cullera from Valencia without a car?", answer: "Yes. Renfe Cercanías connects Valencia with Cullera, and the official local bus links the station with the centre, beaches and lighthouse area. Verify both timetables and the final return service." },
      { question: "Which Cullera beach is best for a first visit?", answer: "San Antonio is the simplest urban choice for orientation, promenade access and nearby services. Cullera also has quieter, more natural and water-sports beaches, so choose according to your group rather than trying to visit several." },
      { question: "Is Cullera Castle accessible?", answer: "The castle lists adapted parking and a panoramic lift, but the lift has seasonal hours and does not operate in rain or wind. Confirm current conditions before travelling." },
      { question: "Can I combine Cullera Castle and the beach in one day?", answer: "Yes. Visit the castle in the morning, then move to one selected beach for lunch and the afternoon. Build the station transfer and return train into the schedule." },
    ],
  },
  {
    slug: "corpus-christi-valencia",
    name: "Corpus Christi Valencia",
    type: "event",
    tagline: "Historic dances, ceremonial floats and processions through Valencia's old city",
    heroImage: "/discover/corpus-christi-valencia.jpg",
    heroImageAlt: "La Moma and a costumed character in Valencia's Corpus Christi Convite Parade",
    heroImageProvenance: {
      status: "licensed",
      creator: "Rafa Esteve",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:2016-05-29_Corpus_Christi_Valencia_05.jpg",
      license: "CC BY-SA 4.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/4.0/",
      verifiedAt: "2026-07-20",
      modifications: "Resized to 1280 pixels wide by Wikimedia Commons.",
    },
    title: "Corpus Christi Valencia: Procession & Traditions",
    description: "Plan Corpus Christi in Valencia with the Convite Parade, La Moma, Rocas, solemn procession, crowd advice and current-programme checks.",
    keywords: ["Corpus Christi Valencia", "Corpus Valencia procession", "La Moma Valencia", "Corpus Christi festival Valencia"],
    date: "2026-07-20",
    lastUpdated: "2026-07-20",
    audiences: ["families", "couples", "elderly", "mobility-needs", "budget"],
    region: "Ciutat Vella, Valencia",
    hubs: ["events"],
    eventInfo: {
      dates: "Annual movable feast; main events on the Sunday after Corpus Christi",
      frequency: "Annual religious and civic celebration",
      ticketsRequired: false,
      ticketUrl: "https://www.visitvalencia.com/en/events-valencia/festivities/corpus-christi-in-valencia",
      crowdLevel: "high",
      bookingAdvice: "Street events are generally free, but the date, route and times must be confirmed from the current official programme before attending.",
      whatToExpect: [
        "The Convite Parade with symbolic figures, dances, giants and the playful Degolla",
        "La Moma, representing virtue in a ritual dance against the seven deadly sins",
        "The Rocas, historic ceremonial floats kept at the municipal Corpus Christi Museum",
        "A solemn religious procession through the historic centre later in the day",
      ],
      safetyTips: [
        "Choose a viewing point with an exit route rather than the narrowest central street.",
        "Expect noise, horses, dense crowds and long periods of standing.",
        "Keep children close during the Degolla and agree a meeting point before the procession.",
        "Check road closures, public-transport diversions and weather on the day.",
      ],
      months: [5, 6],
    },
    overview: {
      paragraphs: [
        "Corpus Christi is one of Valencia's oldest civic and religious celebrations. Its origins reach back to 1263, while the formal procession was established in 1355. The weekend combines Catholic ceremony with costumes, music, dance, symbolism and street traditions that have become part of the city's cultural heritage.",
        "The most distinctive public events include the transfer and passage of the Rocas, the children's Mysteries, the Convite Parade and the solemn procession. La Moma, dressed in white, performs a moral dance representing virtue confronting the seven deadly sins.",
        "The feast moves with the Easter calendar, and the detailed programme changes each year. Use this page to understand the parts of the celebration, then confirm the current date, route, start times and access arrangements through the official programme.",
      ],
      quickFacts: [
        { label: "Origin", value: "Celebrated in Valencia since 1263" },
        { label: "Main area", value: "Ciutat Vella around Plaza de la Virgen" },
        { label: "Admission", value: "Public street events are generally free" },
        { label: "Date", value: "Moves each year with the Easter calendar" },
      ],
    },
    highlights: [
      { name: "Convite Parade", description: "A ceremonial invitation filled with giants, dances, symbolic figures, musicians and the Degolla through the historic centre.", icon: "🎭", tip: "The atmosphere can be playful and noisy; choose a wider route section with children." },
      { name: "La Moma", description: "The white-clad figure of virtue dances against the seven sins in one of the celebration's most recognisable rituals.", icon: "⚪", tip: "Arrive before the published start if seeing the dance is your priority." },
      { name: "The Rocas", description: "Historic wooden ceremonial floats shaped like ships form part of the processions and are preserved in the House of the Rocks.", icon: "⛵", tip: "Visit the municipal museum outside festival hours for a quieter introduction." },
      { name: "Solemn procession", description: "The religious procession brings together historic parishes, biblical figures, the city flag and the Custodia.", icon: "🕯️" },
    ],
    gettingThere: {
      summary: "The main rituals use streets around Plaza de la Virgen and the historic centre. Event closures can change the final approach.",
      options: [
        { mode: "metro", description: "Use a central Metrovalencia station and walk the final section, checking any event-day access change." },
        { mode: "bus", description: "EMT routes may divert around Ciutat Vella. Check live stops before leaving." },
        { mode: "walk", description: "Walking is usually simplest once inside the centre, but narrow streets and crowds slow movement." },
      ],
      parkingNotes: "Do not plan around street parking inside Ciutat Vella. Road closures and procession routes make public transport or a remote car park more reliable.",
    },
    bestTimeToVisit: {
      summary: "Select the ritual you most want to see rather than standing through every programme block. Conditions can be hot by late spring or early summer.",
      seasons: [
        { season: "spring", description: "Corpus often falls in late spring, with warm conditions and possible strong sun.", rating: 5 },
        { season: "summer", description: "When the calendar places the feast near summer, heat and hydration become central to the plan.", rating: 4 },
        { season: "autumn", description: "The festival does not take place in autumn.", rating: 1 },
        { season: "winter", description: "The festival does not take place in winter.", rating: 1 },
      ],
    },
    whatToBring: {
      bring: ["Current official programme", "Water", "Sun protection", "Comfortable shoes", "A meeting-point plan"],
      dontBring: ["Large bags", "Glass containers", "Equipment that blocks narrow viewing areas"],
      rentInstead: ["A compact stroller only if your route includes a quieter viewing point", "A suitable mobility aid for extended standing and walking"],
    },
    accessibility: {
      overallRating: 2,
      summary: "Historic paving, narrow streets, standing crowds and route closures make accessibility highly dependent on the selected viewing point.",
      wheelchairNotes: "Confirm any designated accessible area and its entrance through the current official programme. Arrive before crowd barriers restrict movement.",
      strollerNotes: "A compact stroller can help between events but becomes difficult in the narrowest crowded streets. Use a wider route section and keep an exit path.",
      publicTransportAccess: "Central public transport is available, but event diversions and crowd controls can alter the final approach.",
    },
    visitingHere: {
      summary: "For a first visit, choose the Convite Parade or the solemn procession as the anchor, then add the Rocas or museum context if timing allows.",
      idealDuration: "2-4 hours for one programme block",
      bestTimeOfDay: "According to the current programme; arrive early for your chosen ritual",
      tips: [
        "Pick one wider viewing point instead of following the whole route.",
        "Visit the House of the Rocks on another day for close-up context.",
        "Leave room for transport diversions and slow movement through Ciutat Vella.",
      ],
    },
    practicalTips: [
      "Verify the current-year programme rather than relying on traditional approximate times.",
      "Choose between the livelier Convite Parade and the more formal solemn procession.",
      "Avoid the narrowest route sections with a stroller or mobility aid.",
      "Respect the religious character of the solemn procession while photographing or moving through the crowd.",
    ],
    productWidgets: [],
    relatedDestinations: ["valencia-historic-centre", "central-market-la-lonja", "el-carmen"],
    relatedBlogPosts: ["valencia-with-kids-complete-guide", "accessible-valencia-complete-guide"],
    faqs: [
      { question: "When is Corpus Christi in Valencia?", answer: "The feast moves with the Easter calendar and is celebrated around the Sunday after Corpus Christi. Confirm the exact date and programme through the current official source." },
      { question: "What is La Moma?", answer: "La Moma is the white-clad central figure in a ritual dance representing virtue confronting the seven deadly sins, performed during the Corpus traditions." },
      { question: "Do I need tickets for Corpus Christi?", answer: "The principal street parades and procession are generally free to watch. Separate venues or reserved areas may have their own conditions." },
      { question: "Is Corpus Christi suitable for children?", answer: "Yes, especially the colourful Convite Parade, but the Degolla, horses, noise and dense crowds require close supervision and a carefully chosen viewing point." },
    ],
  },
  {
    slug: "christmas-valencia",
    name: "Christmas in Valencia",
    type: "event",
    tagline: "Lights, nativity scenes, markets and Three Kings traditions across the city",
    heroImage: "/discover/christmas-valencia.jpg",
    heroImageAlt: "Christmas star and nativity lights above a street in Valencia at night",
    heroImageProvenance: {
      status: "licensed",
      creator: "Dimitri Nicolopoulos",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Navidad-Valencia.jpg",
      license: "CC BY-SA 3.0 Spain",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/3.0/es/deed.en",
      verifiedAt: "2026-07-20",
      modifications: "Resized to 1280 pixels wide by Wikimedia Commons.",
    },
    title: "Christmas in Valencia: Markets, Lights & Traditions",
    description: "Plan Christmas in Valencia with lights, nativity scenes, markets, New Year's Eve and Three Kings, plus transport and closure guidance.",
    keywords: ["Christmas in Valencia", "Valencia Christmas markets", "Valencia Christmas lights", "Three Kings Valencia"],
    date: "2026-07-20",
    lastUpdated: "2026-07-20",
    audiences: ["families", "couples", "elderly", "mobility-needs", "budget"],
    region: "Valencia citywide",
    hubs: ["events"],
    eventInfo: {
      dates: "Late November to 6 January; programme published annually",
      frequency: "Annual Christmas and Three Kings season",
      ticketsRequired: false,
      ticketUrl: "https://www.visitvalencia.com/en/christmas",
      crowdLevel: "high",
      bookingAdvice: "Lights and public traditions are generally free, while shows, attractions and workshops may require tickets. The 2026 programme is not yet published; verify every date and venue when it is released.",
      whatToExpect: [
        "Christmas lights and decorations across central streets and neighbourhoods",
        "Municipal and cultural nativity scenes in public squares, museums and churches",
        "Seasonal markets around the Central Market and other locations that vary each year",
        "New Year's Eve celebrations and the Three Kings parade on 5 January",
      ],
      safetyTips: [
        "Expect the busiest central squares during evenings, weekends and 5 January.",
        "Check holiday public-transport hours and road closures before late events.",
        "Use a family meeting point and keep children close during parades and crowded markets.",
        "Confirm venue opening on 24, 25 and 31 December and 1 and 6 January.",
      ],
      months: [12, 1],
    },
    overview: {
      paragraphs: [
        "Christmas in Valencia is a season rather than one event. Lights, nativity scenes, markets, concerts and family activities build through December, followed by New Year's Eve and the Three Kings traditions that culminate on 5 and 6 January.",
        "The most useful first route stays around the historic centre: Plaza del Ayuntamiento, Plaza de la Reina, the Central Market area and selected municipal or cultural nativity scenes. Families may then add one ticketed activity or the Three Kings parade rather than trying to cover every temporary attraction.",
        "The detailed municipal programme, market licences, lighting times and parade route change each year. As of July 2026, the 2026 Christmas programme has not been published. This guide covers stable traditions and planning decisions; all operational details must be checked when official information appears.",
      ],
      quickFacts: [
        { label: "Season", value: "Late November through 6 January" },
        { label: "Family finale", value: "Three Kings on 5-6 January" },
        { label: "Core area", value: "Historic centre and Plaza del Ayuntamiento" },
        { label: "2026 programme", value: "Not yet published; check again in November" },
      ],
    },
    highlights: [
      { name: "Lights and central squares", description: "Plaza del Ayuntamiento and the surrounding shopping streets form the easiest evening route once the annual lights are switched on.", icon: "✨", tip: "Confirm the current switch-on date and operating hours before planning a dedicated trip." },
      { name: "Nativity-scene route", description: "Municipal, museum, church and market displays turn the historic centre into a walkable cultural route.", icon: "🌟", tip: "Locations and opening hours change; choose three nearby displays from the current list." },
      { name: "Christmas markets", description: "Seasonal stalls traditionally appear around the Central Market and other city locations, with dates and product rules set annually.", icon: "🎁", tip: "Treat every published market schedule as year-specific." },
      { name: "Three Kings", description: "The evening parade on 5 January is the major family finale before gifts are traditionally opened on 6 January.", icon: "👑", tip: "The route and arrival arrangements change; use the current municipal programme only." },
    ],
    gettingThere: {
      summary: "Most central Christmas sights are walkable once you reach Ciutat Vella, but crowds and temporary closures affect the final route.",
      options: [
        { mode: "metro", description: "Use central Metrovalencia stations and check holiday closing times for the return journey." },
        { mode: "bus", description: "EMT reaches central and neighbourhood events, with diversions during New Year's Eve and the Three Kings parade." },
        { mode: "walk", description: "Walking works best for a compact lights-and-nativity route through the historic centre." },
      ],
      parkingNotes: "Central parking and road access become difficult during major evenings. Use public transport or park outside the event area.",
    },
    bestTimeToVisit: {
      summary: "Early weekday evenings offer lights with fewer crowds. Families should avoid stacking a late central route with another major activity.",
      seasons: [
        { season: "spring", description: "The Christmas programme does not take place in spring.", rating: 1 },
        { season: "summer", description: "The Christmas programme does not take place in summer.", rating: 1 },
        { season: "autumn", description: "Late November may bring the first lights and markets once the official programme begins.", rating: 3 },
        { season: "winter", description: "December through 6 January is the full season, with the busiest dates around holidays and Three Kings.", rating: 5 },
      ],
      avoidDates: "Avoid assuming normal opening hours on public holidays, and expect the greatest crowd pressure on headline evenings.",
    },
    whatToBring: {
      bring: ["Current official programme", "Warm layers", "Comfortable shoes", "Charged phone", "Family meeting point"],
      dontBring: ["Large bags in crowded markets", "A rigid list of temporary attractions", "Unverified old programme screenshots"],
      rentInstead: ["A compact stroller for younger children", "A mobility aid suitable for a long city-centre route"],
    },
    accessibility: {
      overallRating: 3,
      summary: "Central squares are generally reachable, but crowds, historic paving, temporary stalls and parade barriers can narrow accessible routes.",
      wheelchairNotes: "Confirm step-free entrances for indoor nativity scenes and any accessible viewing arrangements for the Three Kings parade.",
      strollerNotes: "A compact stroller works for quieter evenings but becomes difficult in dense markets and parade crowds. Choose an early time and wider streets.",
      publicTransportAccess: "Central stations and bus routes are available, subject to holiday hours, diversions and event closures.",
    },
    visitingHere: {
      summary: "Build one compact historic-centre route around lights and two or three confirmed displays. Treat New Year's Eve and Three Kings as separate event days.",
      idealDuration: "2-4 hours for a central evening route",
      bestTimeOfDay: "Early evening on a weekday once the lights are operating",
      tips: [
        "Check every indoor venue's holiday opening before walking there.",
        "Choose one ticketed family activity at most per day.",
        "Keep the Three Kings parade separate from ordinary sightseeing.",
      ],
    },
    practicalTips: [
      "Return in November for the official 2026 programme rather than using the previous season's dates.",
      "Group Plaza del Ayuntamiento, Plaza de la Reina and the Central Market area into one walking route.",
      "Reserve restaurants directly for Christmas Eve, Christmas Day or New Year's Eve if they are part of your plan.",
      "Check public-transport hours before late-night celebrations and public holidays.",
    ],
    productWidgets: [],
    relatedDestinations: ["valencia-historic-centre", "central-market-la-lonja", "el-carmen"],
    relatedBlogPosts: ["valencia-with-kids-complete-guide", "accessible-valencia-complete-guide"],
    faqs: [
      { question: "When does Christmas start in Valencia?", answer: "The season usually begins in late November or early December and continues through Three Kings on 6 January. The lights, markets and programme dates are confirmed annually." },
      { question: "Are Valencia's Christmas activities free?", answer: "Lights, public squares and many nativity scenes are free. Shows, attractions, workshops and some reserved activities may require tickets." },
      { question: "Where are the main Christmas sights in Valencia?", answer: "Plaza del Ayuntamiento, Plaza de la Reina and the Central Market area form a practical first route, supplemented by the current municipal nativity-scene and market listings." },
      { question: "When is the Three Kings parade in Valencia?", answer: "The parade traditionally takes place on 5 January, but arrival details, route and start time change. Use the current municipal programme before choosing a viewing point." },
    ],
  },
];
